...
var $author$project$Signup$Main$update = F2(
	function (msg, model) {
...
var $author$project$Signup$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Unlock a World of Faith and Fun!')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('At Catholic Stories for Children, we\'re dedicated to making Catholic teachings engaging and accessible for families. By signing up for our newsletter, you\'ll receive: ')
							])),
						A2(
						$elm$html$Html$ul,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('list-disc pl-5 mb-10')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Free Animations: ')
											])),
										A2(
										$elm$html$Html$span,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text(' Bring Catholic prayers, saints, and stories to life with our vibrant animations.')
											]))
									])),
								A2(
								$elm$html$Html$li,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Exciting Activities: ')
											])),
										A2(
										$elm$html$Html$span,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('Engage your children with fun, faith-filled activities that reinforce what they learn.')
											]))
									])),
								A2(
								$elm$html$Html$li,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Valuable Resources: ')
											])),
										A2(
										$elm$html$Html$span,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('Access a treasure trove of tools and tips to support your family\'s spiritual journey.')
											]))
									])),
								A2(
								$elm$html$Html$li,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Exclusive Updates: ')
											])),
										A2(
										$elm$html$Html$span,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('Be the first to know about our latest projects, events, and special offers.')
											]))
									]))
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Join our community of like-minded families and enrich your children\'s faith experience. Sign up today and start exploring the wonderful world of Catholic stories and teachings!')
							]))
					]))
			]));
};
...
var $author$project$Header$viewPageHeaderNoLinks = F2(
	function (currentPage, leftMargin) {
		var _v0 = _Utils_Tuple2('60px', 'grid-cols-[150px_1fr]');
		var height = _v0.a;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Header$viewHeaderTitle, false, currentPage)
				]));
	});
var $author$project$Signup$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'min-height', '700px')
			]),
		_List_fromArray(
			[
				A2($author$project$Header$viewPageHeaderNoLinks, 'Sign Up', $author$project$Helpers$headerMargin),
				$author$project$Signup$Main$viewBody(model),
				$author$project$Footer$viewFooter
			]));
};
var $author$project$Signup$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
		...
		update: $author$project$Signup$Main$update,
		view: $author$project$Signup$Main$view
	});
_Platform_export({'Signup':{'Main':{'init':$author$project$Signup$Main$main(
