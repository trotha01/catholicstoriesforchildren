...
var $author$project$Resources$Subscriptions$Main$SignupMsg = function (a) {
...
var $author$project$Resources$Subscriptions$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Resources$Subscriptions$Main$SignupMsg, cmd));
	});
...
var $author$project$Resources$Subscriptions$Main$viewAboutSubscriptions = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			$elm$html$Html$text('Want monthly content at your front door? Check out these wonderful Catholic subscriptions.')
		]));
var $author$project$Resources$Subscriptions$Main$catholicFamilyCrate = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/7_i5fOMR9CEB.png?updatedAt=1685581542221', link: 'https://catholicfamilycrate.com', name: 'Catholic Family Crate'};
var $author$project$Resources$Subscriptions$Main$diaryOfAGodman = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/27_LJ8rjMXH6.png?updatedAt=1682716507484', link: 'https://www.diaryofagodman.com/subscriptions', name: 'Diary of a God-Man'};
var $author$project$Resources$Subscriptions$Main$faithAndFamilyCollective = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/6_tZqBkQ3sW.png?updatedAt=1685581578667', link: 'https://faithandfamilycollective.com', name: 'Faith + Family Collective'};
var $author$project$Resources$Subscriptions$Main$formed = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/9_6wjdaJHdc.png?updatedAt=1685581568223', link: 'https://formed.org', name: 'Formed'};
var $author$project$Resources$Subscriptions$Main$magnifiKid = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/8_qucgsetg84.png?updatedAt=1685581652225', link: 'https://us.magnificat.net/home/magnifikid', name: 'MagnifiKid'};
var $author$project$Resources$Subscriptions$Main$massBox = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/5_GX7izsR5Jp.png?updatedAt=1685581558288', link: 'https://themassbox.com', name: 'Mass Box'};
var $author$project$Resources$Subscriptions$Main$osvKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/3_1__qbNDjJEy1.png?updatedAt=1685581657645', link: 'https://osvkids.com/magazine/', name: 'OSV Kids Magazine'};
var $author$project$Resources$Subscriptions$Main$saintOfTheMonth = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/4_1__LjeiFaCGM1.png?updatedAt=1685581640310', link: 'https://www.saintofthemonth.com', name: 'Saint of the Month Box'};
...
var $author$project$Resources$Subscriptions$Main$viewSubscriptions = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
...
var $author$project$Resources$Subscriptions$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Resources$Subscriptions$Main$SignupMsg,
						$author$project$Signup$view(model.signup))
					])),
				$author$project$Resources$Subscriptions$Main$viewAboutSubscriptions,
				$author$project$Resources$Subscriptions$Main$viewSubscriptions,
...
var $author$project$Resources$Subscriptions$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Header$viewSubpageHeader, 'Subscriptions', $author$project$Helpers$headerMargin)),
				$author$project$Resources$Subscriptions$Main$viewBody(model),
				$zwilias$elm_html_string$Html$String$toHtml($author$project$Footer$viewFooter)
			]));
};
var $author$project$Resources$Subscriptions$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Resources$Subscriptions$Main$update,
		view: $author$project$Resources$Subscriptions$Main$view
	});
_Platform_export({'Resources':{'Subscriptions':{'Main':{'init':$author$project$Resources$Subscriptions$Main$main(
