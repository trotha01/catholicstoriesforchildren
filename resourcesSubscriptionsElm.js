...
var $author$project$Resources$Subscriptions$Main$viewAboutSubscriptions = A2(
	...
	_List_fromArray(
		[
			$zwilias$elm_html_string$Html$String$text('Want monthly content at your front door? Check out these wonderful Catholic subscriptions.')
		]));
...
var $author$project$Resources$Subscriptions$Main$catholicFamilyCrate = {image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/7_i5fOMR9CEB.png?updatedAt=1679068242443', link: 'https://catholicfamilycrate.com', name: 'Catholic Family Crate'};
...
var $author$project$Resources$Subscriptions$Main$faithAndFamilyCollective = {image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/6_tZqBkQ3sW.png?updatedAt=1679068242133', link: 'https://faithandfamilycollective.com', name: 'Faith + Family Collective'};
var $author$project$Resources$Subscriptions$Main$formed = {image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/9_6wjdaJHdc.png?updatedAt=1679068242300', link: 'https://formed.org', name: 'Formed'};
var $author$project$Resources$Subscriptions$Main$magnifiKid = {image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/8_qucgsetg84.png?updatedAt=1679068242095', link: 'https://us.magnificat.net/home/magnifikid', name: 'MagnifiKid'};
var $author$project$Resources$Subscriptions$Main$massBox = {image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/5_GX7izsR5Jp.png?updatedAt=1679068242472', link: 'https://themassbox.com', name: 'Mass Box'};
var $author$project$Resources$Subscriptions$Main$osvKids = {image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/3_1__qbNDjJEy1.png?updatedAt=1679068242059', link: 'https://osvkids.com/magazine/', name: 'OSV Kids Magazine'};
var $author$project$Resources$Subscriptions$Main$saintOfTheMonth = {image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/4_1__LjeiFaCGM1.png?updatedAt=1679068242210', link: 'https://www.saintofthemonth.com', name: 'Saint of the Month Box'};
...
var $author$project$Resources$Subscriptions$Main$viewBody = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('Subscriptions')
				])),
...
var $author$project$Resources$Subscriptions$Main$view = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Resources$Subscriptions$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Resources$Subscriptions$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {},
		update: function (_v0) {
		...
		view: function (_v1) {
			return $zwilias$elm_html_string$Html$String$toHtml(
				$zwilias$elm_html_string$Html$String$text(
					A2($zwilias$elm_html_string$Html$String$toString, 0, $author$project$Resources$Subscriptions$Main$view)));
		}
	});
