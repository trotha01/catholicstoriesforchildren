...
var $author$project$Team$Team$carlos = {description: 'Carlos is a CAD designer who also has a passion for dogs, comedy and food.', image: $author$project$Team$Team$imagePath + 'CarlosG.jpg', initials: '', name: 'Carlos Gutierrez', position: 'CFO', socials: _List_Nil};
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Team$Main$viewPerson($author$project$Team$Team$carlos),
