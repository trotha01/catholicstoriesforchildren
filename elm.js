...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{key: key, signup: $author$project$Signup$init, url: url},
...
var $author$project$Main$viewIntro = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('max-w-5xl m-auto'),
...
var $author$project$Main$prayers = {description: 'Find common Catholic prayers here.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/6_qYAX4yqV6.png?updatedAt=1682454350004', link: 'prayers', name: 'Prayers'};
