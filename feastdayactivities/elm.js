...
var $author$project$FeastDayActivities$Main$viewFeastActivities = F2(
	function (model, feastActivitiesList) {
						...
						function (saint) {
							return _List_fromArray(
								[
									...
									_List_fromArray(
									[
										A2($author$project$FeastDayActivities$Main$activityFromLink, saint.name, saint.teachingCatholicKidsLink)
									]),
									_List_fromArray(
									[
		...
		return model.saintList.isLoading ? A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('We are getting the feast day activities, hang tight.')
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
				...
				])) : ($elm$core$List$isEmpty(activities) ? $author$project$FeastDayActivities$FeastDayHelpers$viewNoActivities : A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
