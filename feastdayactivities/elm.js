...
var $author$project$FeastDayActivities$FeastDays$M05May$may = {
	...
	feasts: _List_fromArray(
		[
			...
			feasts: _List_fromArray(
				[
					{activities: _List_Nil, feast: 'The Ascension of the Lord (or 12th)'}
				])
		},
			{
			date: '10',
			...
			feasts: _List_fromArray(
				[
					{activities: _List_Nil, feast: 'The Ascension of the Lord (or the 9th)'},
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('/animations/guardianangel'),
									$elm$html$Html$Attributes$class('underline'),
									$elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									A2(
									$elm$html$Html$map,
									$author$project$FeastDayActivities$Main$SignupMsg,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A4($author$project$Header$viewNavButton, height, '/shop', '_blank', 'Shop'),
