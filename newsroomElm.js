...
var $zwilias$elm_html_string$Html$String$Attributes$hidden = function (bool) {
	return A2($zwilias$elm_html_string$Html$String$Attributes$boolProperty, 'hidden', bool);
};
...
var $author$project$Helpers$email = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('trevor'),
					A2(
					$zwilias$elm_html_string$Html$String$span,
					_List_Nil,
					_List_fromArray(
			...
			_List_fromArray(
				[
					...
					$zwilias$elm_html_string$Html$String$Attributes$width(0),
					A2($zwilias$elm_html_string$Html$String$Attributes$style, 'display', 'none'),
					$zwilias$elm_html_string$Html$String$Attributes$hidden(true)
				]),
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('spam@catholicstoriesforchildren.com')
				])),
			A2(
			$zwilias$elm_html_string$Html$String$span,
			_List_Nil,
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('catholicstoriesforchildren'),
					A2(
					$zwilias$elm_html_string$Html$String$span,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$zwilias$elm_html_string$Html$String$text('com')
								]))
						]))
				]))
		]));
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('Los Angeles, California. ')
						])),
					A2(
					$zwilias$elm_html_string$Html$String$span,
					_List_Nil,
			...
			_List_fromArray(
				[
					...
					A2($zwilias$elm_html_string$Html$String$Attributes$style, 'line-height', '1.4em')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('Media Contacts:')
						])),
					A2($zwilias$elm_html_string$Html$String$br, _List_Nil, _List_Nil),
					A2(
					$zwilias$elm_html_string$Html$String$span,
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('Trevor Rothaus | Founder')
						])),
					A2($zwilias$elm_html_string$Html$String$br, _List_Nil, _List_Nil),
					A2(
					$zwilias$elm_html_string$Html$String$span,
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('iHollywood Film Fest')
						])),
					A2($zwilias$elm_html_string$Html$String$br, _List_Nil, _List_Nil),
					A2(
					$zwilias$elm_html_string$Html$String$span,
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('Joyce Chow | iHollywood Founder & Festival Director')
						])),
					A2($zwilias$elm_html_string$Html$String$br, _List_Nil, _List_Nil),
					A2(
					$zwilias$elm_html_string$Html$String$span,
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('ihollywoodfilmfest@gmail.com')
						])),
					A2($zwilias$elm_html_string$Html$String$br, _List_Nil, _List_Nil),
					A2(
					$zwilias$elm_html_string$Html$String$a,
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$Attributes$href('https://ihollywoodfilmfest.com'),
							A2($zwilias$elm_html_string$Html$String$Attributes$style, 'color', $author$project$Helpers$darkBlue),
							$zwilias$elm_html_string$Html$String$Attributes$rel('noopener'),
							$zwilias$elm_html_string$Html$String$Attributes$target('_blank')
						]),
...
var $author$project$Newsroom$Main$viewPressRelease = function (pr) {
	return A2(
		...
		_List_fromArray(
			[
				A2($zwilias$elm_html_string$Html$String$Attributes$style, 'line-height', '1.6em')
			]),
		_List_fromArray(
			[pr]));
};
...
var $author$project$Newsroom$Main$main = $elm$browser$Browser$sandbox(
	{
		...
		aT: function (_v1) {
			return $zwilias$elm_html_string$Html$String$toHtml(
				$zwilias$elm_html_string$Html$String$text(
					A2($zwilias$elm_html_string$Html$String$toString, 0, $author$project$Newsroom$Main$view)));
		}
	});
