...
var $author$project$Resources$Main$SignupMsg = function (a) {
...
var $author$project$Resources$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Resources$Main$SignupMsg, cmd));
	});
...
var $author$project$Resources$Main$viewAboutResources = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Resources$Main$books = {description: 'Find books here. It\'s hard to go wrong with a good Catholic book.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/2_4YvKGvP_Y.png?updatedAt=1679066449106', link: '/resources/books', name: 'Books'};
var $author$project$Resources$Main$feastDayActivities = {description: 'Find activities for feast days throughout the year', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/feastdaycalendar_1__YTmPRisXH.png?updatedAt=1686096632436', link: '/feastdayactivities', name: 'Feast Day Activities'};
var $author$project$Resources$Main$podcasts = {description: 'Find audio podcasts here. Your kids can listen to them while on the road, traveling, while doing coloring activities, or they can be simply enjoyed by themselves.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/1_EAfo23y5R.png?updatedAt=1679066451335', link: '/resources/podcasts', name: 'Podcasts'};
var $author$project$Resources$Main$prayerResources = {description: 'Find more resources here to help build your prayer life', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/prayerresources_gN76-j6pz.png?updatedAt=1683227269863', link: '/resources/prayer', name: 'Prayer Resources'};
var $author$project$Resources$Main$subscriptions = {description: 'Want monthly content at your front door? Check out these wonderful Catholic subscriptions.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/4_U5qO_iICx.png?updatedAt=1679066449068', link: '/resources/subscriptions', name: 'Subscriptions'};
var $author$project$Resources$Main$videos = {description: 'Find video content here. Videos are a wonderful engaging way to bring a visual representation of the faith into your home.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/3_mTKsUZQuM.png?updatedAt=1679066450272', link: '/resources/videos', name: 'Youtube Channels'};
...
var $author$project$Resources$Main$viewResourceGroup = function (resourceGroup) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
...
var $author$project$Resources$Main$viewResourceGroups = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
		...
		_List_fromArray(
			[$author$project$Resources$Main$books, $author$project$Resources$Main$podcasts, $author$project$Resources$Main$videos, $author$project$Resources$Main$subscriptions, $author$project$Resources$Main$prayerResources, $author$project$Resources$Main$feastDayActivities])));
...
var $author$project$Resources$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Resources$Main$viewAboutResources,
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Resources$Main$SignupMsg,
...
var $author$project$Resources$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Resources$Main$viewBody(model),
				$zwilias$elm_html_string$Html$String$toHtml($author$project$Footer$viewFooter)
			]));
};
var $author$project$Resources$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Resources$Main$update,
		view: $author$project$Resources$Main$view
	});
_Platform_export({'Resources':{'Main':{'init':$author$project$Resources$Main$main(
