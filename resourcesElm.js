...
var $author$project$Resources$Main$books = {description: 'Find books here. It\'s hard to go wrong with a good Catholic book.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/2_4YvKGvP_Y.png?updatedAt=1679066449106', link: 'books', name: 'Books'};
...
var $author$project$Resources$Main$prayerResources = {description: 'Find more resources here to help build your prayer life', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/prayerresources_gN76-j6pz.png?updatedAt=1683227269863', link: 'prayer', name: 'Prayer Resources'};
var $author$project$Resources$Main$subscriptions = {description: 'Want monthly content at your front door? Check out these wonderful Catholic subscriptions.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/4_U5qO_iICx.png?updatedAt=1679066449068', link: 'subscriptions', name: 'Subscriptions'};
var $author$project$Resources$Main$videos = {description: 'Find video content here. Videos are a wonderful engaging way to bring a visual representation of the faith into your home.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/3_mTKsUZQuM.png?updatedAt=1679066450272', link: 'videos', name: 'Youtube Channels'};
...
var $author$project$Resources$Main$viewResourceGroup = function (resourceGroup) {
	return A2(
		...
		_List_fromArray(
			[
				$zwilias$elm_html_string$Html$String$Attributes$class('grid grid-cols-[100px_1fr] hover:bg-csc-lightpurple rounded p-7'),
				$zwilias$elm_html_string$Html$String$Attributes$href('/resources/' + resourceGroup.link),
				A2($zwilias$elm_html_string$Html$String$Attributes$attribute, 'aria-label', resourceGroup.name)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$zwilias$elm_html_string$Html$String$Attributes$src(resourceGroup.image),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$zwilias$elm_html_string$Html$String$text(resourceGroup.name)
							])),
						A2(
						$zwilias$elm_html_string$Html$String$p,
						_List_Nil,
						_List_fromArray(
							[
								$zwilias$elm_html_string$Html$String$text(resourceGroup.description)
							]))
					]))
			]));
};
...
var $author$project$Resources$Main$viewBody = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('Resources')
				])),
...
var $author$project$Resources$Main$view = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Resources$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Resources$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {},
		update: function (_v0) {
		...
		view: function (_v1) {
			return $zwilias$elm_html_string$Html$String$toHtml(
				$zwilias$elm_html_string$Html$String$text(
					A2($zwilias$elm_html_string$Html$String$toString, 0, $author$project$Resources$Main$view)));
		}
	});
