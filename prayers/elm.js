...
var $author$project$Prayers$Main$viewSaints = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Prayers$Main$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Prayers$Main$viewSaints
		]));
...
var $author$project$Prayers$Main$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Prayers', $author$project$Helpers$headerMargin),
			$author$project$Prayers$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Prayers$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {},
		update: function (_v0) {
		...
		view: function (_v1) {
			return $author$project$Prayers$Main$view;
		}
	});
_Platform_export({'Prayers':{'Main':{'init':$author$project$Prayers$Main$main(
