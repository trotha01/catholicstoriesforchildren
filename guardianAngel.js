...
var $author$project$Animations$GuardianAngel$Main$aboutTheAnimation = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('This animation helps kids learn the Hail Mary prayer though a story and repetition.')
				])),
			A2(
			$zwilias$elm_html_string$Html$String$p,
			_List_fromArray(
...
var $zwilias$elm_html_string$Html$String$Attributes$cite = function (val) {
	return A2($zwilias$elm_html_string$Html$String$Attributes$stringProperty, 'cite', val);
};
var $author$project$Animations$GuardianAngel$Main$aboutThePrayer = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('About the Prayer')
				])),
			A2(
			$zwilias$elm_html_string$Html$String$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('The Hail Mary is a beautiful prayer to Mary, the Mother of Jesus. This prayer is filled with Scripture.')
				])),
			A2(
			$zwilias$elm_html_string$Html$String$p,
			_List_fromArray(
			...
			A2(
			$zwilias$elm_html_string$Html$String$blockquote,
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$Attributes$cite('https://www.vatican.va/archive/hist_councils/ii_vatican_council/documents/vat-ii_const_19641121_lumen-gentium_en.html'),
					$zwilias$elm_html_string$Html$String$Attributes$class('my-10'),
					$zwilias$elm_html_string$Html$String$Attributes$class('px-4 py-1 my-4 border-l-4 border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800'),
					$zwilias$elm_html_string$Html$String$Attributes$class('italic')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$Attributes$class('inline'),
							$zwilias$elm_html_string$Html$String$Attributes$class('text-gray-500 dark:text-gray-400')
						]),
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('Because of this gift of sublime grace she far surpasses all creatures, ' + ('both in heaven and on earth. At the same time, however, because ' + ('she belongs to the offspring of Adam she is one with all those who ' + 'are to be saved. ')))
						])),
					A2(
					$zwilias$elm_html_string$Html$String$p,
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$Attributes$class('mt-2')
						]),
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('Lumen Gentium, 53')
						]))
				])),
			A2(
			$zwilias$elm_html_string$Html$String$p,
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('Then we praise Mary in the same way as her cousin Elizabeth, ' + '\'Blessed are you among women, and blessed is the fruit of your womb\' (Luke 1:42).')
				])),
			A2(
			$zwilias$elm_html_string$Html$String$blockquote,
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$Attributes$class('my-10'),
					$zwilias$elm_html_string$Html$String$Attributes$class('px-4 my-4 border-l-4 border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800'),
					$zwilias$elm_html_string$Html$String$Attributes$class('italic'),
					$zwilias$elm_html_string$Html$String$Attributes$cite('https://www.vatican.va/content/john-paul-ii/en/encyclicals/documents/hf_jp-ii_enc_25031987_redemptoris-mater.html')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$zwilias$elm_html_string$Html$String$text('Pope John Paul II, Redemptoris Mater, 8')
						]))
				])),
			A2(
			$zwilias$elm_html_string$Html$String$p,
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('Lastly, we asks Mary to pray for us, ' + 'Holy Mary, Mother of God, pray for us sinners now and at the hour of death. Amen.')
				]))
		]));
				...
				[
					...
					_List_fromArray(
						[
							...
							$zwilias$elm_html_string$Html$String$Attributes$src('https://www.youtube.com/embed/HW0DzGEoa1Y'),
							$zwilias$elm_html_string$Html$String$Attributes$title('Hail Mary, Full of Grace Video'),
							A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($zwilias$elm_html_string$Html$String$Attributes$style, 'top', '0'),
							A2($zwilias$elm_html_string$Html$String$Attributes$style, 'left', '0'),
							$zwilias$elm_html_string$Html$String$Attributes$src('https://www.youtube.com/embed/QNVNbLiqznI'),
							$zwilias$elm_html_string$Html$String$Attributes$title('Hail Mary, Full of Grace Video'),
							A2(
							$zwilias$elm_html_string$Html$String$Attributes$property,
							'frameborder',
