...
var $author$project$Resources$Videos$Main$SignupMsg = function (a) {
...
var $author$project$Resources$Videos$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Resources$Videos$Main$SignupMsg, cmd));
	});
...
var $author$project$Resources$Videos$Main$viewAboutVideos = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$text('Find video content here. Videos are a wonderful engaging way to bring a visual representation of the faith into your home.')
		]));
var $author$project$Resources$Videos$Main$brotherFrancis = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/16_V1sLznRg0.png?updatedAt=1679070333303', link: 'https://www.youtube.com/@BrotherFrancis', name: 'Brother Francis'};
var $author$project$Resources$Videos$Main$catholicIcing = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/41_XrkKmwtXL.png?updatedAt=1682876930378', link: 'https://www.youtube.com/@CatholicIcing', name: 'Catholic Icing'};
var $author$project$Resources$Videos$Main$catholicKidsMedia = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/17_z9ZERCAuK.png?updatedAt=1679070333348', link: 'https://www.youtube.com/@CatholicKidsMedia', name: 'Catholic Kids Media'};
var $author$project$Resources$Videos$Main$catholicSongsForKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/40_vS6tZTdD3.png?updatedAt=1682876930344', link: 'https://www.youtube.com/@catholicsongsforkids', name: 'Catholic Songs for Kids'};
var $author$project$Resources$Videos$Main$catholicStoriesForChildren = {image: 'https://ik.imagekit.io/catholicstories/CSCLogo_JiNT9WUPX.png?updatedAt=1679070448402', link: 'https://www.youtube.com/@CatholicStoriesforChildren', name: 'Catholic Stories For Children'};
var $author$project$Resources$Videos$Main$christineInAction = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/christineinaction_Le5_7yr2K.jpeg?updatedAt=1682821244341', link: 'https://www.youtube.com/@ChristineInAction', name: 'Christine In Action'};
var $author$project$Resources$Videos$Main$opusJoyous = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/opusjoyouslogo__bVhpC3Fj.jpeg?updatedAt=1687549207653', link: 'https://www.youtube.com/@OpusJoyous', name: 'Opus Joyous'};
var $author$project$Resources$Videos$Main$prostradaDesigns = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/42_GMJuNZEVs.png?updatedAt=1683226627331', link: 'https://www.youtube.com/@prostradadesignsllc', name: 'Prostrada Designs'};
var $author$project$Resources$Videos$Main$tomkin = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/15_Wrw3_kbKK.png?updatedAt=1679070333309', link: 'https://www.youtube.com/playlist?list=PL9CQlldupc5_L0shwBi1w-n5liWhD0ArO', name: 'Tomkin'};
...
var $author$project$Resources$Videos$Main$viewVideos = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
		...
		_List_fromArray(
			[$author$project$Resources$Videos$Main$catholicStoriesForChildren, $author$project$Resources$Videos$Main$christineInAction, $author$project$Resources$Videos$Main$tomkin, $author$project$Resources$Videos$Main$catholicKidsMedia, $author$project$Resources$Videos$Main$brotherFrancis, $author$project$Resources$Videos$Main$catholicSongsForKids, $author$project$Resources$Videos$Main$catholicIcing, $author$project$Resources$Videos$Main$opusJoyous, $author$project$Resources$Videos$Main$prostradaDesigns])));
...
var $author$project$Resources$Videos$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Youtube Channels')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Resources$Videos$Main$SignupMsg,
						$author$project$Signup$view(model.signup))
					])),
				$author$project$Resources$Videos$Main$viewAboutVideos,
				$author$project$Resources$Videos$Main$viewVideos,
...
var $author$project$Resources$Videos$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Header$viewSubpageHeader, 'Youtube Channels', $author$project$Helpers$headerMargin)),
				$author$project$Resources$Videos$Main$viewBody(model),
				$zwilias$elm_html_string$Html$String$toHtml($author$project$Footer$viewFooter)
			]));
};
var $author$project$Resources$Videos$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Resources$Videos$Main$update,
		view: $author$project$Resources$Videos$Main$view
	});
_Platform_export({'Resources':{'Videos':{'Main':{'init':$author$project$Resources$Videos$Main$main(
