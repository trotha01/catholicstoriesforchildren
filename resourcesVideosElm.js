...
var $author$project$Resources$Videos$Main$viewBody = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('Youtube Channels')
				])),
...
var $author$project$Resources$Videos$Main$view = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Resources$Videos$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Resources$Videos$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {},
		update: function (_v0) {
		...
		view: function (_v1) {
			return $zwilias$elm_html_string$Html$String$toHtml(
				$zwilias$elm_html_string$Html$String$text(
					A2($zwilias$elm_html_string$Html$String$toString, 0, $author$project$Resources$Videos$Main$view)));
		}
	});
