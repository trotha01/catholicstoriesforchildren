...
var $author$project$Header$viewBanner = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('bg-[#9101b3] bg-[url(/assets/images/AnimationImageLinks/SotsJoseph.png)] text-white text-center text-lg py-2')
		]),
	_List_fromArray(
		[
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Support our new animation - ')
								])),
							A2(
							$elm$html$Html$span,
							_List_fromArray(
...
var $author$project$Team$Team$carlos = {description: '', image: $author$project$Team$Team$imagePath + 'CarlosG.jpg', initials: '', name: 'Carlos Gutierrez', position: 'Creative Consultant', socials: _List_Nil};
	...
	return A3(
		...
		_List_fromArray(
			[
				...
				$author$project$Animations$View$viewProductions(model.animationsPageModel))
			]));
};
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$target('_blank'),
									$elm$html$Html$Attributes$class('flex flex-col items-center justify-center rounded p-7 text-center bg-white text-black w-full sm:w-96 my-10')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Learn More')
...
var $author$project$Main$more = {description: 'Find more resources here.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/5_siQ_tckr-C.png?updatedAt=1682454350018', link: 'resources', name: 'More Resources', resources: _List_Nil};
var $author$project$Main$prayers = {description: 'Find prayers resources and information here.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/6_qYAX4yqV6.png?updatedAt=1682454350004', link: 'resources/prayer', name: 'Prayers', resources: _List_Nil};
var $author$project$Main$saints = {description: 'Find a list of saints here.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/7_nqDiNpO9Q.png?updatedAt=1682454350040', link: 'saints', name: 'Saints', resources: _List_Nil};
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('mb-10 text-4xl sm:text-7xl')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Resources')
...
var $author$project$Shop$ShopHelpers$confirmandiHoodie = {beehiivLink: '', description: 'Get your Confirmandi Hoodie here!', etsyLink: '', image: '/assets/images/shop/confirmandihoodie.webp', link: 'https://catholicstoriesforchildren.printful.me/product/confirmandi-youth-heavy-blend-hoodie-durable-comfortable-confirmation-apparel', name: 'Confirmandi Youth Heavy Blend Hoodie'};
var $author$project$Shop$ShopHelpers$cscWaterBottle = {beehiivLink: '', description: 'Get your CSC Water Bottle here!', etsyLink: '', image: '/assets/images/shop/cscwaterbottle.webp', link: 'https://catholicstoriesforchildren.printful.me/product/catholic-stories-for-children-stainless-steel-water-bottle-32-oz-with-straw-lid', name: 'Catholic Stories for Children Stainless Steel Water Bottle – 32 oz with Straw Lid'};
var $author$project$Shop$ShopHelpers$guardianAngelSpiralNotebook = {beehiivLink: '', description: 'Get your Guardian Angel Spiral Notebook here!', etsyLink: '', image: '/assets/images/shop/guardianangelsspiralnotebook.webp', link: 'https://catholicstoriesforchildren.printful.me/product/guardian-angels-spiral-notebook-featuring-the-angel-of-god-prayer-and-the-guardian-angels', name: 'Guardian Angel Spiral Notebook'};
var $author$project$Shop$ShopHelpers$pinkLittleFlowerTote = {beehiivLink: '', description: 'Get your Pink Little Flower Tote Bag here!', etsyLink: '', image: '/assets/images/shop/PinkLittleFlowerTote.webp', link: 'https://catholicstoriesforchildren.printful.me/product/pink-little-flower-tote-bag', name: 'Pink Little Flower Tote Bag'};
var $author$project$Shop$ShopHelpers$prayedtodayshirt = {beehiivLink: '', description: 'Get your I Prayed Today Shirt here!', etsyLink: '', image: '/assets/images/shop/prayedtodayshirt.webp', link: 'https://catholicstoriesforchildren.printful.me/product/prayed-today-womens-short-sleeve-t-shirt-featuring-daisy-and-sheep', name: 'Prayed Today? Women’s Short Sleeve T-Shirt'};
var $author$project$Shop$ShopHelpers$redlittleflowertote = {beehiivLink: '', description: 'Get your Red Little Flower Tote Bag here!', etsyLink: '', image: '/assets/images/shop/RedLittleFlowerTote.webp', link: 'https://catholicstoriesforchildren.printful.me/product/little-flower-tote-bag', name: 'Red Little Flower Tote Bag'};
var $author$project$Shop$ShopHelpers$stmichaelholographicsticker = {beehiivLink: '', description: 'Get your St. Michael Holographic Sticker here!', etsyLink: '', image: '/assets/images/shop/stmichaelholographicsticker.webp', link: 'https://catholicstoriesforchildren.printful.me/product/holographic-stickers-6750c6047592c', name: 'St. Michael Holographic Sticker'};
var $author$project$Shop$ShopHelpers$stmichaelyouthshirt = {beehiivLink: '', description: 'Get your St. Michael Youth T-Shirt here!', etsyLink: '', image: '/assets/images/shop/stmichaelyouthshirt.webp', link: 'https://catholicstoriesforchildren.printful.me/product/st-michael-youth-short-sleeve-t-shirt-defend-us-in-battle', name: 'St. Michael Youth T-Shirt'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('grid grid-cols-2 lg:grid-cols-4 gap-4 pb-4 mb-10')
					]),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('https://catholicstoriesforchildren.printful.me/'),
						$elm$html$Html$Attributes$target('_blank'),
						$elm$html$Html$Attributes$class('flex flex-col items-center justify-center rounded p-7 text-center bg-[#E95A03] text-white w-full sm:w-96')
					]),
				_List_fromArray(
					[
