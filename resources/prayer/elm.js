...
var $author$project$Resources$Prayer$Main$SignupMsg = function (a) {
...
var $author$project$Resources$Prayer$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Resources$Prayer$Main$SignupMsg, cmd));
	});
...
var $author$project$Resources$Prayer$Main$viewVideos = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
...
var $author$project$Resources$Prayer$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Resources$Prayer$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Resources$Prayer$Main$viewBody(model),
				$author$project$Footer$viewFooter
			]));
};
var $author$project$Resources$Prayer$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Resources$Prayer$Main$update,
		view: $author$project$Resources$Prayer$Main$view
	});
_Platform_export({'Resources':{'Prayer':{'Main':{'init':$author$project$Resources$Prayer$Main$main(
