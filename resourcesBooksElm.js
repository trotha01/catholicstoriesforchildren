	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($zwilias$elm_html_string$Html$String$Attributes$attribute, 'aria-label', resource.name),
				$zwilias$elm_html_string$Html$String$Attributes$href(resource.link)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$zwilias$elm_html_string$Html$String$Attributes$src(resource.image),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$zwilias$elm_html_string$Html$String$text(resource.name)
							]))
					]))
			]));
};
var $author$project$Resources$Books$Main$viewBooks = A2(
	...
	A2(
		...
		_List_fromArray(
			[$author$project$Resources$Books$Main$littleSaintStories, $author$project$Resources$Books$Main$theotokosKids, $author$project$Resources$Books$Main$osvKidsBooks, $author$project$Resources$Books$Main$theLittleRoseShop, $author$project$Resources$Books$Main$brotherFrancisBooks, $author$project$Resources$Books$Main$thyOliveTree, $author$project$Resources$Books$Main$lightOfTheSaints, $author$project$Resources$Books$Main$firstFaithTreasury, $author$project$Resources$Books$Main$tanBooks, $author$project$Resources$Books$Main$ewtnKidsBooks, $author$project$Resources$Books$Main$diaryOfAGodMan, $author$project$Resources$Books$Main$catholicSprouts, $author$project$Resources$Books$Main$holyHeroesBooks, $author$project$Resources$Books$Main$loyolaPressBooks, $author$project$Resources$Books$Main$stPaulCenter, $author$project$Resources$Books$Main$cBPSaints, $author$project$Resources$Books$Main$paulineBooksAndMediaForKids])));
...
var $author$project$Resources$Books$Main$viewBody = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$Attributes$class('my-10 leading-10')
				]),
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('Books')
				])),
...
var $author$project$Resources$Books$Main$view = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Resources$Books$Main$viewBody,
