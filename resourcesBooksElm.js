...
var $author$project$Resources$Books$Main$SignupMsg = function (a) {
...
var $author$project$Resources$Books$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Resources$Books$Main$SignupMsg, cmd));
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$src('https://ik.imagekit.io/catholicstories/FREE_Mass_Guide_WbtXzqb2I.png?updatedAt=1687994011730')
				]),
			_List_Nil)
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$class('lg:grid lg:grid-cols-2')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-left text-base col-span-2')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('🌟 It\'s FREE! Empower kids this week!')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
...
var $author$project$Resources$Books$Main$viewAboutBooks = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			$elm$html$Html$text('Find books here. It\'s hard to go wrong with a good Catholic book.')
		]));
var $author$project$Resources$Books$Main$brotherFrancisBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/16_V1sLznRg0.png?updatedAt=1679070333303', link: 'https://brotherfrancisstore.com/collections/books', name: 'Brother Francis Books'};
var $author$project$Resources$Books$Main$cBPSaints = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/38_oB0pzZnMW8.png?updatedAt=1682716506417', link: 'https://catholicbookpublishing.com/browse/childrens-books-on-saints', name: 'Catholic Book Publishing\'s Children\'s Books on Saints'};
var $author$project$Resources$Books$Main$catholicSprouts = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/26_2TkstMXTY.png?updatedAt=1682716507634', link: 'https://shop.catholicsprouts.com/collections/all', name: 'Catholic Sprouts Books and Materials'};
var $author$project$Resources$Books$Main$ctsBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/CTS_Logo_vwbekKAI-.png?updatedAt=1687667974185', link: 'https://www.ctsbooks.org/product-category/children-young-adults/', name: 'Catholic Truth Society'};
var $author$project$Resources$Books$Main$diaryOfAGodMan = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/27_LJ8rjMXH6.png?updatedAt=1682716507484', link: 'https://www.diaryofagodman.com/books', name: 'Diary of a God-Man. A fully illustrated children\'s missal'};
var $author$project$Resources$Books$Main$ewtnKidsBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/30_SPGrEpxn4o.png?updatedAt=1682716506374', link: 'https://www.ewtnreligiouscatalogue.com/Catholic-Childrens-Books', name: 'EWTN Childrens Books'};
var $author$project$Resources$Books$Main$firstFaithTreasury = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/33_v8d9TN1XkY.png?updatedAt=1682716506330', link: 'https://firstfaithtreasury.com/', name: 'First Faith Treasury'};
var $author$project$Resources$Books$Main$holyHeroesBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/25_OSP8-2xFJ.png?updatedAt=1682716507604', link: 'https://holyheroes.com/collections/catholic-childrens-books', name: 'Holy Heroes Books'};
var $author$project$Resources$Books$Main$lightOfTheSaints = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/36_eINHZkemx9.png?updatedAt=1682716506020', link: 'https://bookstore.wordonfire.org/products/light-of-the-saints', name: 'Light of the Saints'};
var $author$project$Resources$Books$Main$littleSaintStories = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/34_GtSZ5NI8_8.png?updatedAt=1682716506395', link: 'https://www.littlesaintstories.com/s/shop', name: 'Little Saint Stories'};
var $author$project$Resources$Books$Main$loyolaPressBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/23_UvXPxYgqml.png?updatedAt=1682716507758', link: 'https://www.loyolapress.com/', name: 'Loyola Press Books'};
var $author$project$Resources$Books$Main$osvKidsBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/3rd_Party_Logos_DxY5MCRoK.png?updatedAt=1682716853025', link: 'https://osvkids.com/books/', name: 'OSV Kids Books'};
var $author$project$Resources$Books$Main$paulineBooksAndMediaForKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/37_gMX8cczFD.png?updatedAt=1682716506298', link: 'https://paulinestore.com/kids-teens.html', name: 'Pauline Books and Media'};
var $author$project$Resources$Books$Main$stPaulCenter = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/35_evg05JJAFh.png?updatedAt=1682716506043', link: 'https://stpaulcenter.com/product-category/children/', name: 'St Paul Center Children\'s Books'};
var $author$project$Resources$Books$Main$tanBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/32_22z_5JUPjM.png?updatedAt=1682716506412', link: 'https://tanbooks.com/catholic-kids-books/', name: 'Tan Books for Kids'};
var $author$project$Resources$Books$Main$theLittleRoseShop = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/29_9r_mR-lb6.png?updatedAt=1682716506911', link: 'https://thelittleroseshop.com/collections/baby-kids', name: 'The Little Rose Shop Fabric Books'};
var $author$project$Resources$Books$Main$theotokosKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/28_INemNiAcr.png?updatedAt=1682716507584', link: 'https://theotokoskids.com/collections/books', name: 'Theotokos Kids Books'};
var $author$project$Resources$Books$Main$thyOliveTree = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/24_ok9wTkcFo.png?updatedAt=1682716507750', link: 'https://www.thyolivetree.com/collections/childrens', name: 'Thy Olive Tree'};
...
var $author$project$Resources$Books$Main$viewBooks = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
		...
		_List_fromArray(
			[$author$project$Resources$Books$Main$littleSaintStories, $author$project$Resources$Books$Main$theotokosKids, $author$project$Resources$Books$Main$osvKidsBooks, $author$project$Resources$Books$Main$theLittleRoseShop, $author$project$Resources$Books$Main$brotherFrancisBooks, $author$project$Resources$Books$Main$thyOliveTree, $author$project$Resources$Books$Main$lightOfTheSaints, $author$project$Resources$Books$Main$firstFaithTreasury, $author$project$Resources$Books$Main$tanBooks, $author$project$Resources$Books$Main$ctsBooks, $author$project$Resources$Books$Main$ewtnKidsBooks, $author$project$Resources$Books$Main$diaryOfAGodMan, $author$project$Resources$Books$Main$catholicSprouts, $author$project$Resources$Books$Main$holyHeroesBooks, $author$project$Resources$Books$Main$loyolaPressBooks, $author$project$Resources$Books$Main$stPaulCenter, $author$project$Resources$Books$Main$cBPSaints, $author$project$Resources$Books$Main$paulineBooksAndMediaForKids])));
var $author$project$Resources$Helpers$viewWorkInProgressNotice = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('grid grid-cols-[100px_1fr] rounded py-7')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$src('https://ik.imagekit.io/catholicstories/Construction_Cone_vLoPMhMZBm.png?updatedAt=1679070884463'),
							$elm$html$Html$Attributes$class('w-20 h-20 object-cover')
						]),
					_List_Nil)
				])),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('This page is a work-in-progress. We are working hard on adding resources this page for you.')
						]))
				]))
		]));
var $author$project$Resources$Books$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Resources$Books$Main$SignupMsg,
						$author$project$Signup$view(model.signup))
					])),
				$author$project$Resources$Books$Main$viewAboutBooks,
...
var $author$project$Resources$Books$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Header$viewSubpageHeader, 'Books', $author$project$Helpers$headerMargin)),
				$author$project$Resources$Books$Main$viewBody(model),
				$zwilias$elm_html_string$Html$String$toHtml($author$project$Footer$viewFooter)
			]));
};
var $author$project$Resources$Books$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Resources$Books$Main$update,
		view: $author$project$Resources$Books$Main$view
	});
_Platform_export({'Resources':{'Books':{'Main':{'init':$author$project$Resources$Books$Main$main(
