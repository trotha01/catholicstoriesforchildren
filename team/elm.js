		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://calendly.com/csc-trevor/30min'),
...
var $author$project$Team$Team$boardOfAdvisors = _List_fromArray(
	[$author$project$Team$Team$fredrick, $author$project$Team$Team$aaron, $author$project$Team$Team$chris, $author$project$Team$Team$cheri]);
...
var $author$project$Team$Team$staff = _List_fromArray(
	[$author$project$Team$Team$trevor, $author$project$Team$Team$carlos]);
