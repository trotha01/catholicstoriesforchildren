...
var $author$project$Team$Join$Main$viewAbout = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Team$Join$Main$viewOpportunities = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('mt-16 mb-7')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Animation Internship')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Mostly Remote /\u00A0based near Orange County, CA')
								]))
						])),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Ten weeks. Approximately nine hours per week')
								]))
						])),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('$20 per hour.')
								]))
						])),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('October 1, 2024')
								]))
						])),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('January, 2025')
								]))
						])),
					...
					_List_fromArray(
						[
							$elm$html$Html$text('We are looking for an emerging 2-D animation artist to animate backgrounds and digital assets for two projects.')
						])),
					A2(
					$elm$html$Html$ul,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('ml-5')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Project One: ')
								])),
							A2(
							$elm$html$Html$span,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('A live-action animation series for YouTube. The series features a husband-and-wife composer/performer team, teaching preschool aged children songs with hand motions about their Catholic faith.')
								])),
							A2(
							$elm$html$Html$li,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Project Two: ')
								])),
							A2(
							$elm$html$Html$span,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('A series of shorts teaching children about famous saints. This project  is in collaboration with a well-known Catholic retailer, specializing in quiet books for infants/toddlers, and uses their original illustrations.')
								]))
						])),
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('The internship will last for the length of the spring semester with the possibility of turning into a project-based contracted position.')
						])),
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Key Qualifications:')
						])),
					A2(
					$elm$html$Html$ul,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('list-disc ml-5')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Desire to share our Catholic faith with children and families.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Excellent communication skills, openness to collaboration, teachable attitude.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Computer proficiency (Google Suites, able to learn new software/apps).')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Computer requirements: Must be able to run Adobe Suite products.')
								]))
						])),
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Note: We are constantly updating our projects. The details may change from what is described above.')
						])),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://forms.clickup.com/18021848/f/h5zer-2871/77ETSZW1EQHQ2BHB9A'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Videographer Internship')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('$20 per hour. Day Rate for Filming Days: $220 per diem.')
								]))
						])),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Cinematography interns will be expected to light subjects, capture footage according to the script/shot list provided by CSC producers, and edit the final film. (All locations will be within driving distance of San Diego, CA).')
						])),
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Desire to help secular/religious communities increase vocations.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://forms.clickup.com/18021848/f/h5zer-2891/N0BN94ZV7P09TSEZ9K'),
							$elm$html$Html$Attributes$rel('noopener'),
							$elm$html$Html$Attributes$target('_blank'),
							$elm$html$Html$Attributes$class('mt-5'),
							A2($elm$html$Html$Attributes$style, 'text-decoration', 'none'),
...
var $author$project$Team$Join$Main$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Join the Team')
				])),
			$author$project$Team$Join$Main$viewAbout,
			$author$project$Team$Join$Main$viewOpportunities
		]));
...
var $author$project$Team$Join$Main$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Join the Team', $author$project$Helpers$headerMargin),
			$author$project$Team$Join$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Team$Join$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {},
		update: function (_v0) {
		...
		view: function (_v1) {
			return $author$project$Team$Join$Main$view;
		}
	});
_Platform_export({'Team':{'Join':{'Main':{'init':$author$project$Team$Join$Main$main(
