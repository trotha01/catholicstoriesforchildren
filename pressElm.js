...
var $author$project$Press$Main$viewPressRelease = function (pr) {
	return A2(
		$zwilias$elm_html_string$Html$String$div,
		_List_fromArray(
			[
...
var $author$project$Press$Main$viewPressReleases = function (prs) {
	return A2(
		$zwilias$elm_html_string$Html$String$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Press$Main$viewPressRelease, prs));
};
var $author$project$Press$Main$viewBody = A2(
	...
	_List_fromArray(
		[
			...
			$author$project$Press$Main$viewPressReleases(
			_List_fromArray(
				[$author$project$Press$PR20220912$view]))
		]));
...
var $author$project$Press$Main$view = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Press$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Press$Main$main = $elm$browser$Browser$sandbox(
	{
		aD: {},
		aR: function (_v0) {
		...
		aT: function (_v1) {
			return $zwilias$elm_html_string$Html$String$toHtml(
				$zwilias$elm_html_string$Html$String$text(
					A2($zwilias$elm_html_string$Html$String$toString, 0, $author$project$Press$Main$view)));
		}
	});
_Platform_export({'Press':{'Main':{'init':$author$project$Press$Main$main(
