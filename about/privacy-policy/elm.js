...
var $author$project$About$PrivacyPolicy$Main$viewBody = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('This privacy policy explains the privacy practices of Catholic Stories for Children ("CSC") and how CSC treats your information.')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
...
var $author$project$About$PrivacyPolicy$Main$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Contact', $author$project$Helpers$headerMargin),
			$author$project$About$PrivacyPolicy$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$About$PrivacyPolicy$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {},
		update: function (_v0) {
		...
		view: function (_v1) {
			return $author$project$About$PrivacyPolicy$Main$view;
		}
	});
_Platform_export({'About':{'PrivacyPolicy':{'Main':{'init':$author$project$About$PrivacyPolicy$Main$main(
