...
var $zwilias$elm_html_string$Html$String$form = $zwilias$elm_html_string$Html$String$node('form');
...
var $zwilias$elm_html_string$Html$String$Attributes$type_ = function (val) {
	return A2($zwilias$elm_html_string$Html$String$Attributes$stringProperty, 'type', val);
};
...
var $author$project$Give$Main$donateWithVehicle = A2(
	...
	A2(
		...
		_List_fromArray(
			[
				$zwilias$elm_html_string$Html$String$Attributes$href('http://www.cars2charities.org/donation?donateto=1585'),
				$zwilias$elm_html_string$Html$String$Attributes$rel('noopener'),
				$zwilias$elm_html_string$Html$String$Attributes$target('_blank'),
				A2($zwilias$elm_html_string$Html$String$Attributes$style, 'text-decoration', 'none'),
...
var $author$project$Give$Main$prayForUs = A2(
	...
	A2(
		...
		_List_fromArray(
			[
				$zwilias$elm_html_string$Html$String$text('We believe in the power of prayer. Please pray for us in this work. We are praying for you. 🙏')
			])));
	...
	A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$zwilias$elm_html_string$Html$String$text(' Interested in becoming a sponsor? Please send us a message! ')
					])),
...
var $author$project$Give$Main$viewBody = A2(
	...
	_List_fromArray(
		[
			...
			$author$project$Give$Main$h1Style,
			_List_fromArray(
				[
...
var $author$project$Give$Main$main = $elm$browser$Browser$sandbox(
	{
		...
		aT: function (_v1) {
			return $zwilias$elm_html_string$Html$String$toHtml(
				$zwilias$elm_html_string$Html$String$text(
					A2($zwilias$elm_html_string$Html$String$toString, 0, $author$project$Give$Main$view)));
		}
	});
