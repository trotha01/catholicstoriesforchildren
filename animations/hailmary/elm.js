...
var $author$project$Animations$HailMary$Main$viewVideo = function (link) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$title('Hail Mary, Full of Grace Video'),
								A2(
								$elm$html$Html$Attributes$property,
								'frameborder',
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				var _v0 = model.H;
				if (!_v0) {
					return $author$project$Animations$HailMary$Main$viewVideo($author$project$Animations$HailMary$Main$englishVideoLink);
				} else {
					return $author$project$Animations$HailMary$Main$viewVideo($author$project$Animations$HailMary$Main$aslVideoLink);
				}
			}()
			]));
};
