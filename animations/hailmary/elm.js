...
var $author$project$Animations$HailMary$Main$English = {$: 'English'};
...
var $author$project$Animations$HailMary$Main$SignupMsg = function (a) {
		...
		if (msg.$ === 'SignupMsg') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{signup: signup}),
				A2($elm$core$Platform$Cmd$map, $author$project$Animations$HailMary$Main$SignupMsg, cmd));
		} else {
			var language = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Animations$HailMary$Main$aboutTheAnimation = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Welcome to Catholic Stories for Children! I’m Trevor Rothaus, the founder. You’ve visited our website because, like me, you know that Mother Mary is one of the most people in our Catholic faith. She is admired for her unwavering faith, humility, and devotion to her son, Jesus Christ.')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
...
var $author$project$Animations$HailMary$Main$moreAboutTheAnimation = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('mx-auto col-span-2 w-full'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('I invite you to receive this free guide on bringing kids to Mass. We asked parents for their top tips and put it together in this guide for you. This guide is completely free and you can start using it this week!')
				]))
		]));
...
var $author$project$Animations$HailMary$Main$viewActivities = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Hail Mary Prayer Activities')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Hail Mary Prayer Activities'),
									$elm$html$Html$Attributes$href('/printables/Hail-Mary-Activities.pdf'),
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$src('https://ik.imagekit.io/catholicstories/9_1__-d-EPYcuW.png?updatedAt=1689288132704')
										]),
									_List_Nil)
								]))
						])),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Answers to Hail Mary Prayer activity questions.')
								])),
							A2(
							$elm$html$Html$a,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Hail Mary Activity Answers'),
									$elm$html$Html$Attributes$href('/printables/Hail-Mary-Activity-Answers.pdf'),
									$elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('w-full max-w-[400px]'),
											$elm$html$Html$Attributes$class('transition ease-in-out hover:scale-110'),
											$elm$html$Html$Attributes$src('https://ik.imagekit.io/catholicstories/10_1__s3i8dhFiH.png?updatedAt=1689288132684')
										]),
									_List_Nil)
								]))
						]))
...
var $author$project$Animations$HailMary$Main$viewResources = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('mx-auto col-span-2 w-full'),
...
var $author$project$Animations$HailMary$Main$ASL = {$: 'ASL'};
var $author$project$Animations$HailMary$Main$VideoTabClick = function (a) {
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Animations$HailMary$Main$VideoTabClick($author$project$Animations$HailMary$Main$English))
									]),
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick(
										$author$project$Animations$HailMary$Main$VideoTabClick($author$project$Animations$HailMary$Main$ASL))
									]),
								_List_fromArray(
									[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Teaching Children about Mother Mary through Animated Stories')
					])),
				...
				_List_fromArray(
					[$author$project$Animations$HailMary$Main$viewActivities])),
				$author$project$Animations$HailMary$Main$viewPrayer,
				$author$project$Animations$HailMary$Main$moreAboutTheAnimation,
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Animations$HailMary$Main$SignupMsg,
				...
				_List_fromArray(
					[$author$project$Animations$HailMary$Main$viewResources])),
...
var $author$project$Animations$HailMary$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				{signup: $author$project$Signup$init, videoTab: $author$project$Animations$HailMary$Main$English},
				$elm$core$Platform$Cmd$none);
		},
		subscriptions: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Animations$HailMary$Main$update,
		view: $author$project$Animations$HailMary$Main$view
	});
