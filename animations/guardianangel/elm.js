...
var $author$project$Animations$GuardianAngel$Main$SignupMsg = function (a) {
...
var $author$project$Animations$GuardianAngel$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Animations$GuardianAngel$Main$SignupMsg, cmd));
	});
...
var $author$project$Animations$GuardianAngel$Main$viewActivities = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Guardian Angel Activities')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Guardian Angel Activities'),
									$elm$html$Html$Attributes$href('/printables/Guardian-Angel-Activities.pdf'),
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$src('https://ik.imagekit.io/catholicstories/Guardian_Angel_Activity_Cover_1__vNBJQA8Y8.png?updatedAt=1688494259496')
										]),
									_List_Nil)
								]))
						])),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Answers to Guardian Angel activity questions.')
								])),
							A2(
							$elm$html$Html$a,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Guardian Angel Activities'),
									$elm$html$Html$Attributes$href('/printables/Guardian-Angel-Activity-Answers.pdf'),
									$elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('w-full max-w-[400px]'),
											$elm$html$Html$Attributes$class('transition ease-in-out hover:scale-110'),
											$elm$html$Html$Attributes$src('https://ik.imagekit.io/catholicstories/Guardian_Angel_Activities_Answers_3__-3FACN8K8.png?updatedAt=1688495546612')
										]),
									_List_Nil)
								]))
						]))
...
var $author$project$Animations$GuardianAngel$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Animations$GuardianAngel$Main$SignupMsg,
				...
				_List_fromArray(
					[$author$project$Animations$GuardianAngel$Main$viewActivities])),
...
var $author$project$Animations$GuardianAngel$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Animations$GuardianAngel$Main$viewBody(model),
				$author$project$Footer$viewFooter
			]));
};
var $author$project$Animations$GuardianAngel$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Animations$GuardianAngel$Main$update,
		view: $author$project$Animations$GuardianAngel$Main$view
	});
