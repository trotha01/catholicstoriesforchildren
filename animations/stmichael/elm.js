...
var $author$project$Animations$StMichael$Main$init = {prayerTab: $author$project$Animations$StMichael$Main$English};
...
var $author$project$Animations$StMichael$Main$viewActivities = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('St Michael Activities')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$attribute, 'aria-label', 'St Michael Activities'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('max-w-[400px]'),
							$elm$html$Html$Attributes$class('transition ease-in-out hover:scale-110'),
							$elm$html$Html$Attributes$src('https://ik.imagekit.io/catholicstories/Saint_Michael_Activities_aLiVSlyfv.png?updatedAt=1682603552845')
						]),
					_List_Nil)
				]))
		]));
...
var $author$project$Animations$StMichael$Main$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Animations$StMichael$Main$viewBody,
			$zwilias$elm_html_string$Html$String$toHtml($author$project$Footer$viewFooter)
		]));
var $author$project$Animations$StMichael$Main$main = $elm$browser$Browser$sandbox(
	{
		init: $author$project$Animations$StMichael$Main$init,
		update: function (_v0) {
		...
		view: function (_v1) {
			return $author$project$Animations$StMichael$Main$view;
		}
	});
