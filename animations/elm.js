...
var $author$project$Animations$Main$SignupMsg = function (a) {
...
var $author$project$Animations$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Animations$Main$SignupMsg, cmd));
	});
...
var $author$project$Animations$Main$animations = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Animations$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mt-10 leading-10')
					]),
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								A2(
								$elm$html$Html$map,
								$author$project$Animations$Main$SignupMsg,
								$author$project$Signup$view(model.signup))
							]))
					])),
				$author$project$Animations$Main$animations
			]));
};
...
var $author$project$Animations$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Animations$Main$viewBody(model),
				$author$project$Footer$viewFooter
			]));
};
var $author$project$Animations$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Animations$Main$update,
		view: $author$project$Animations$Main$view
	});
_Platform_export({'Animations':{'Main':{'init':$author$project$Animations$Main$main(
