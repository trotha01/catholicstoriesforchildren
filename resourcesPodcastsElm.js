...
var $author$project$Resources$Podcasts$Main$viewBody = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$zwilias$elm_html_string$Html$String$text('Podcasts')
				])),
...
var $author$project$Resources$Podcasts$Main$view = A2(
	$zwilias$elm_html_string$Html$String$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Resources$Podcasts$Main$viewBody,
