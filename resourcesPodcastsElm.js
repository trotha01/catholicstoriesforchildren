...
var $author$project$Resources$Podcasts$Main$SignupMsg = function (a) {
...
var $author$project$Resources$Podcasts$Main$update = F2(
	function (msg, model) {
		var signupMsg = msg.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{signup: signup}),
			A2($elm$core$Platform$Cmd$map, $author$project$Resources$Podcasts$Main$SignupMsg, cmd));
	});
...
var $author$project$Resources$Podcasts$Main$viewAboutPodcasts = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			$elm$html$Html$text('Find audio podcasts here. Your kids can listen to them while on the road, traveling, while doing coloring activities, or they can be simply enjoyed by themselves.')
		]));
var $author$project$Resources$Podcasts$Main$catholicKidsPodcast = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/3rd_Party_Logos_Mz1VR_PBx.png?updatedAt=1679071655063', link: 'https://podcasts.apple.com/us/podcast/catholic-kids-podcast/id1557527100', name: 'Catholic Kids Podcast'};
var $author$project$Resources$Podcasts$Main$catholicKidsTriviaPodcast = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/CatholicKidsTriviaPodcast_rFHEiGK88.png?updatedAt=1679071809107', link: 'https://podcasts.apple.com/us/podcast/catholic-kids-trivia-podcast/id1662532400', name: 'Catholic Kids Trivia Podcast'};
var $author$project$Resources$Podcasts$Main$catholicSprouts = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/11_HUKazDTNih.png?updatedAt=1679069711765', link: 'https://podcasts.apple.com/ca/podcast/catholic-sprouts-daily-podcast-for-catholic-kids/id1406174660', name: 'Catholic Sprouts'};
var $author$project$Resources$Podcasts$Main$onTheNightTrain = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/On_The_Night_Train_Uy2SqRG8B.png?updatedAt=1679069840295', link: 'https://podcasts.apple.com/us/podcast/on-the-night-train/id1638922447', name: 'On The Night Train'};
var $author$project$Resources$Podcasts$Main$saintStoriesForKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/10_W0OwjM8Yu.png?updatedAt=1679069711783', link: 'https://podcasts.apple.com/ca/podcast/saint-stories-for-kids/id1448514363', name: 'Saint Stories for Kids'};
var $author$project$Resources$Podcasts$Main$saintsAlive = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/14_Aps0ku8wH.png?updatedAt=1679069710842', link: 'https://podcasts.apple.com/us/podcast/saints-alive-podcast/id1598392451', name: 'Saints Alive'};
var $author$project$Resources$Podcasts$Main$thatsTheWord = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/12_NwOXTTpkTi.png?updatedAt=1679069710890', link: 'https://podcasts.apple.com/us/podcast/thats-the-word-with-fr-james-yamauchi/id1540449749', name: 'That\'s the word'};
...
var $author$project$Resources$Podcasts$Main$viewPodcasts = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
...
var $author$project$Resources$Podcasts$Main$viewBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Resources$Podcasts$Main$SignupMsg,
						$author$project$Signup$view(model.signup))
					])),
				$author$project$Resources$Podcasts$Main$viewAboutPodcasts,
				$author$project$Resources$Podcasts$Main$viewPodcasts,
...
var $author$project$Resources$Podcasts$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Header$viewSubpageHeader, 'Podcasts', $author$project$Helpers$headerMargin)),
				$author$project$Resources$Podcasts$Main$viewBody(model),
				$zwilias$elm_html_string$Html$String$toHtml($author$project$Footer$viewFooter)
			]));
};
var $author$project$Resources$Podcasts$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
		...
		update: $author$project$Resources$Podcasts$Main$update,
		view: $author$project$Resources$Podcasts$Main$view
	});
_Platform_export({'Resources':{'Podcasts':{'Main':{'init':$author$project$Resources$Podcasts$Main$main(
