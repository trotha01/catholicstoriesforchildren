module Page.About.TermsAndConditions.Main exposing (..)
...
viewBody =
    div []
        ...
        , div [ class "" ]
            [ p [ class "m-10" ] [ text """ These terms and conditions govern your use of the Claritas Studios website, accessible from https://claritasstudios.com/.  """ ]
            ...
            , p [ class "mt-10 mx-10" ] [ text """Permission is granted to temporarily download one copy of the materials (information or software) on Claritas Studios's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license, you may not:""" ]
            , ul [ class "list-disc" ]
                ...
                , li [ class "mx-20" ] [ text """attempt to decompile or reverse engineer any software contained on Claritas Studios's website;""" ]
            ...
            , p [ class "m-10" ]
                [ span [] [ text """Your use of Claritas Studios's website is also governed by our Privacy Policy. Please review our """ ]
