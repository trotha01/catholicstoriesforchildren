...
import Page.Shop.ShopHelpers exposing (littleReconciliationBooklet, liturgicalCalendar2025, viewShopItem, viewShopItem2)
...
view3 =
    div
        [ class "p-3 rounded-md border-4 border-solid border-[#460156]"
        ]
