module Page.Resources.Prayer.Main exposing (..)
...
viewPrayerSteps =
    div []
        ...
        , p []
            ...
            , span [] [ a [ href "/animations/prayertimewithangels/1/guardianangelprayer", class "underline" ] [ text "our animation" ] ]
            , span [] [ text " to help your kids understand this prayer. You can also find Guardian Angel Prayer activities on " ]
            , span [] [ a [ href "/animations/prayertimewithangels/1/guardianangelprayer", class "underline" ] [ text "our animation page" ] ]
            ]
        , p [ class "mt-4 italic" ]
        ...
        , p []
            ...
            , span [] [ a [ href "/animations/prayertimewithangels/1/saintmichaelprayer", class "underline" ] [ text "our animation" ] ]
            , span [] [ text " to help your kids understand this prayer. You can also find Saint Michael Prayer activities on " ]
            , span [] [ a [ href "/animations/prayertimewithangels/1/saintmichaelprayer", class "underline" ] [ text "our animation page" ] ]
            , span [] [ text "." ]
            ]
        , p [ class "mt-4 italic" ]
