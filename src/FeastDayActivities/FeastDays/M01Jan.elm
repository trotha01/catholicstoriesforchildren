                ...
                [ { feast = "Mary, Mother of God"
                  , activities =
                        ...
                        , { activityType = Audio
                          ...
                          , snippet = "Mary’s divine motherhood broadens the Christmas spotlight. Mary has an important role to play in the Incarnation of the Second Person of the Blessed Trinity..."
                          }
                        , { activityType = Game
          ...
          , feasts =
                [ { feast = "Saint Basil"
                  , activities =
                        ...
                        , { activityType = Audio
                          , title = "Saint Basil the Great’s Story"
                          , image = "https://ik.imagekit.io/catholicstories/FeastDayActivities/FranciscanMediaLogo_H3hNRUlza.png?ik-sdk-version=javascript-1.4.3&updatedAt=1676251074960"
                          , link = "https://www.franciscanmedia.org/saint-of-the-day/saint-basil-the-great/"
                          , snippet = "Basil was on his way to becoming a famous teacher when he decided to begin a religious life of gospel poverty..."
                          }
                        , { activityType = OnlineReading
          ...
          , feasts =
                [ { feast = "The Most Holy Name of Jesus"
                  , activities =
                        ...
                        , { activityType = Audio
                          , title = "The Story of the Most Holy Name of Jesus"
                          , image = "https://ik.imagekit.io/catholicstories/FeastDayActivities/FranciscanMediaLogo_H3hNRUlza.png?ik-sdk-version=javascript-1.4.3&updatedAt=1676251074960"
                          , link = "https://www.franciscanmedia.org/saint-of-the-day/most-holy-name-of-jesus/"
                          , snippet = "Although Saint Paul might claim credit for promoting devotion to the Holy Name because Paul wrote in Philippians that God the Father gave Christ Jesus “that name that is above every name” (see 2:9), this devotion became popular because of 12th-century Cistercian monks and nuns but especially..."
                          }
                        ...
                        , { activityType = Book
                          ...
                          , snippet = """This booklet, "The Wonders of the Holy Name," reveals the simplest secret of holiness and happiness ever. For it shows us how we can pray "without ceasing," pray "always," and pray "at all times," as Holy Scripture exhorts us..."""
                          }
                        , { activityType = Food
                ...
                [ { feast = "Saint Elizabeth Ann Seton"
                  , activities =
                        ...
                        , { activityType = Audio
                          ...
                          , snippet = "Mother Seton is one of the keystones of the American Catholic Church. She founded the first American religious community for women, the Sisters of Charity. She opened the first American parish school and established the first American Catholic orphanage. All this she did in the span of 46 years while raising her five children..."
                          }
                        , { activityType = Printout
          ...
          , feasts =
                [ { feast = "Saint John Newmann"
                  , activities =
                        ...
                        , { activityType = Audio
                          , title = "Saint John Neumann’s Story"
                          , image = "https://ik.imagekit.io/catholicstories/FeastDayActivities/FranciscanMediaLogo_H3hNRUlza.png?ik-sdk-version=javascript-1.4.3&updatedAt=1676251074960"
                          , link = "https://www.franciscanmedia.org/saint-of-the-day/saint-john-neumann/"
                          , snippet = "Perhaps because the United States got a later start in the history of the world, it has relatively few canonized saints, but their number is increasing. John Neumann was born in what is now the Czech Republic. After studying in Prague, he came to New York at 25 and was ordained a priest..."
                          }
                        , { activityType = OnlineReading
                ...
                [ { feast = "Saint André Bessette"
                  , activities =
                        ...
                        , { activityType = Audio
                          ...
                          , snippet = "Brother André expressed a saint’s faith by a lifelong devotion to Saint Joseph. Sickness and weakness dogged André from birth..."
                          }
                        , { activityType = Food
          ...
          , feasts =
                [ { feast = "Saint Raymond of Penyafort"
                  , activities =
                        ...
                        , { activityType = Audio
                          , title = "Saint Raymond of Peñafort’s Story"
                          , image = "https://ik.imagekit.io/catholicstories/FeastDayActivities/FranciscanMediaLogo_H3hNRUlza.png?ik-sdk-version=javascript-1.4.3&updatedAt=1676251074960"
                          , link = "https://www.franciscanmedia.org/saint-of-the-day/saint-raymond-of-penafort/"
                          , snippet = "Since Raymond lived into his hundredth year, he had a chance to do many things. As a member of the Spanish nobility, he had the resources and the education to get a good start in life..."
                          }
                        , { activityType = OnlineReading
                ...
                [ { feast = "Saint Fabian"
                  , activities =
                        ...
                        , { activityType = Audio
                          ...
                          , snippet = "Fabian was a Roman layman who came into the city from his farm one day as clergy and people were preparing to elect a new pope..."
                          }
                        , { activityType = Food
        ...
        , { date = "25"
          , feasts =
                [ { feast = "The Conversion of Saint Paul"
                  , activities =
                        [ { activityType = Audio
                          , title = "The Story of the Conversion of Saint Paul"
                          , image = "https://ik.imagekit.io/catholicstories/FeastDayActivities/FranciscanMediaLogo_H3hNRUlza.png?ik-sdk-version=javascript-1.4.3&updatedAt=1676251074960"
                          , link = "https://www.franciscanmedia.org/saint-of-the-day/conversion-of-saint-paul/"
                          , snippet = "Saint Paul’s entire life can be explained in terms of one experience—his meeting with Jesus on the road to Damascus..."
                          }
                        ]
                  }
                ]
                ...
                [ { feast = "Saint Timothy and Titus"
                  , activities =
                        ...
                        , { activityType = Food
                          ...
                          , link = "https://www.saintsfeastfamily.com/copy-of-st-francis-de-sales-jan-24"
                          , snippet = """"Potato Stew". Whenever Kompir Mandza is made, the house smells like heaven. The longer this stew cooks, the better."""
                          }
                        , { activityType = Food
