module Animations.DaisyAndSheep.LiturgicalKiss.Main exposing (..)
...
view model =
    div
        ...
        [ viewSubpageHeader "Liturgical Kiss" headerMargin
        , viewBody model
        , viewFooter
        ]
...
viewVideoPlayers model =
    div
        ...
        , case model.videoTab of
            English ->
                viewVideo "Liturgical Kiss | Daisy and Sheep" englishVideoLink

            Spanish ->
                viewVideo "Liturgical Kiss | Daisy and Sheep" spanishVideoLink
        ]
...
viewVideoPlayer link =
    div
        ...
        [ viewVideo "Liturgical Kiss | Daisy and Sheep" link
        ]
...
aboutTheAnimation =
    div
        ...
        [ p [ class "my-3" ]
            [ text
                ("Use this animation to help your children learn about the Liturgical Kiss."
...
viewActivities =
    div []
        [ h2 [ class "mb-3 mt-5" ] [ text "Liturgical Kiss" ]
        , div [ class "grid grid-cols-2 gap-4" ]
            [ div []
                ...
                , a
                    [ attribute "aria-label" "Liturgical Kiss"
                    , href "/printables/daisyandsheep/Liturgical Kiss.pdf"
                    , target "_blank"
                    ]
                    [ img
                        [ class "w-full max-w-[400px]"
                        , class "transition ease-in-out hover:scale-110"
                        , src "/assets/images/daisyandsheep/liturgicalkissworksheet.png"
                        ]
                        []
                    ]
                ]
            , div []
                [ p [ class "h-14" ]
                    [ text "Answers to Liturgical Kiss activity questions."
                    ]
                , a
                    [ attribute "aria-label" "Liturgical Kiss Activity Answers"
                    , href "/printables/daisyandsheep/Liturgical Kiss Answer Key.pdf"
                    , target "_blank"
                    ]
                    [ img
                        [ class "w-full max-w-[400px]"
                        , class "transition ease-in-out hover:scale-110"
                        , src "/assets/images/daisyandsheep/liturgicalkissworksheetanswers.png"
                        ]
                        []
                    ]
                ]
