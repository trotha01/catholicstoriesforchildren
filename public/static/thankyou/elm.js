...
var $author$project$Page$ThankYou$Main$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Page$ThankYou$Main$UrlChanged = function (a) {
...
var $author$project$Page$ThankYou$Main$Model = F2(
	function (key, url) {
		return {key: key, url: url};
	});
var $author$project$Page$ThankYou$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A2($author$project$Page$ThankYou$Main$Model, key, url),
			$elm$core$Platform$Cmd$none);
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Page$ThankYou$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Page$ThankYou$Main$goBack = _Platform_outgoingPort('goBack', $elm$json$Json$Encode$string);
...
var $author$project$Page$ThankYou$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'LinkClicked':
			...
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Page$ThankYou$Main$goBack(''));
		}
	});
...
var $author$project$Page$ThankYou$Main$viewThankYou = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Hello, I want to personally thank you for connecting with us! We are thrilled to have you on board.')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('In the coming minutes, look out for an email containing your free printable. I will also be keeping you in the loop regarding our upcoming animations and activities. We have so many exciting projects coming up to teach the Catholic faith to kids!')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Here at Claritas Studios, we are dedicated to creating valuable resources for parents, grandparents, and Catholics like you.')
						])),
					A2(
					$elm$html$Html$span,
					_List_Nil,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Your input will directly contribute to the creation of animations and resources that resonate with Catholic families and provide an enjoyable and faithful experience for children. I look forward to connecting with you soon. Thank you for being an essential part of our community at Claritas Studios.')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Founder - Claritas Studios')
						]))
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bg-white rounded')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$src('https://calendar.google.com/calendar/appointments/schedules/AcZssZ1q_LityalnFrAKQ20-YIKG1HeQAv2DK8ExvFS1QacsSAj_HfKe-aZlqQAGpWvNWWJro6D6ynkV?gv=true'),
...
var $author$project$Page$ThankYou$Main$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Thank you for connecting with Claritas Studios!')
						])),
					$author$project$Page$ThankYou$Main$viewThankYou
				]))
		]));
...
var $author$project$Page$ThankYou$Main$view = function (model) {
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$Component$Header$viewSubpageHeader, 'Thank You', $author$project$Theme$Layout$headerMargin),
						$author$project$Page$ThankYou$Main$viewBody,
...
var $author$project$Page$ThankYou$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Page$ThankYou$Main$init, onUrlChange: $author$project$Page$ThankYou$Main$UrlChanged, onUrlRequest: $author$project$Page$ThankYou$Main$LinkClicked, subscriptions: $author$project$Page$ThankYou$Main$subscriptions, update: $author$project$Page$ThankYou$Main$update, view: $author$project$Page$ThankYou$Main$view});
_Platform_export({'Page':{'ThankYou':{'Main':{'init':$author$project$Page$ThankYou$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Page.ThankYou.Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Page.ThankYou.Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"GoBack":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}}}});}(this));