...
var $author$project$Page$NotFound$Main$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Page$NotFound$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {},
		update: function (_v0) {
		...
		view: function (_v1) {
			return $author$project$Page$NotFound$Main$view;
		}
	});
_Platform_export({'Page':{'NotFound':{'Main':{'init':$author$project$Page$NotFound$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Basics.Never","aliases":{},"unions":{"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}}}}})}}}});}(this));