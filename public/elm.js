...
var $author$project$Main$Navigation = {$: 'Navigation'};
...
var $author$project$Give$View$donateWithZeffy = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'position', 'relative'),
...
var $author$project$Animations$SongsOfTheSaints$SotSEpisodes$carloVideoDescription = A2(
	...
	_List_fromArray(
		[
			...
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			$author$project$Give$View$donateWithZeffy
		]));
...
var $author$project$Animations$SongsOfTheSaints$SotSEpisodes$donationButton = function (str) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('dbox-donation-page-button m-auto mt-10 bg-pink-600 no-underline font-sans flex text-lg px-8 py-4 rounded gap-2 w-fit leading-6'),
				$elm$html$Html$Attributes$class('shadow-lg transition-shadow duration-300 ease-in-out hover:shadow-xl'),
...
var $author$project$Animations$SongsOfTheSaints$SotSEpisodes$imgClass = 'w-3/4 my-10 mx-auto';
var $elm$html$Html$li = _VirtualDom_node('li');
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Animations$SongsOfTheSaints$SotSEpisodes$josephVideoDescription = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Bring our Saint Joseph Animation to Life')
				])),
			A2(
			$elm$html$Html$img,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Join us on Kickstarter')
						])),
					A2(
					$elm$html$Html$span,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(' to raise the funds needed to animate this moment in Saint Joseph\'s life.')
						]))
				])),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Your generosity ensures that more animations like "Songs of the Saints: Saint Joseph" reach families around the world, strengthening the faith of the next generation through beauty, truth, and goodness.')
				])),
			$author$project$Animations$SongsOfTheSaints$SotSEpisodes$donationButton('Support Our Next Animation'),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			A2(
			$elm$html$Html$h2,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Price Breakdown')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('There are a number of costs with every animation, including the character design, background artwork, rigging, animation, sound effects and mix, directing, and marketing.')
				])),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			A2(
			$elm$html$Html$p,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('$4,400 - Pre-production (Character Design, Rigging, Background Artwork, Storyboards)')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('$9,550 - Production (Voice Acting and Singing, Animation, Sound Effects and Mix, Directing)')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('$500 - Marketing')
								]))
						])),
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('$14,450 - Total')
						])),
					$author$project$Animations$SongsOfTheSaints$SotSEpisodes$donationButton('Help Us Cover The Costs')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			$author$project$Animations$SongsOfTheSaints$SotSEpisodes$donationButton('Bring the Magnificat Song to Life'),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			A2(
			$elm$html$Html$h2,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Pay it Forward')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Every donation allows a family to experience the beauty of the Catholic faith through animation. We are so grateful for your support!')
				])),
			$author$project$Animations$SongsOfTheSaints$SotSEpisodes$donationButton('Pay it Forward'),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class($author$project$Animations$SongsOfTheSaints$SotSEpisodes$imgClass),
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Supporting this Animation')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
...
var $author$project$Animations$SongsOfTheSaints$SotSEpisodes$josephEpisode = {
	about: $author$project$Animations$SongsOfTheSaints$SotSEpisodes$josephVideoDescription,
	activities: {answerPdfLink: '', answerThumbnailLink: '', pdfLink: '', thumbnailLink: ''},
	isDisabled: false,
	isFundraising: true,
	link: '',
...
var $author$project$Animations$SongsOfTheSaints$SotSEpisodes$episodes = _List_fromArray(
	[$author$project$Animations$SongsOfTheSaints$SotSEpisodes$stThereseEpisode, $author$project$Animations$SongsOfTheSaints$SotSEpisodes$carloEpisode, $author$project$Animations$SongsOfTheSaints$SotSEpisodes$josephEpisode]);
...
var $author$project$Animations$Productions$productions = _List_fromArray(
	[
		...
		{about: $author$project$Animations$PrayerTimeWithAngels$PTWAEpisodes$viewBody, carouselThumbnail: '/assets/images/CarouselThumbnails/resized/PrayerTimeWithAngels.webp', link: '/animations/prayertimewithangels', seasons: $author$project$Animations$PrayerTimeWithAngels$PTWAEpisodes$seasons, thumbnail: '/assets/images/AnimationImageLinks/PrayerTimeWithAngels.webp', title: 'Prayer Time with Angels'},
		{about: $author$project$Animations$DaisyAndSheep$DASEpisodes$viewDescription, carouselThumbnail: '/assets/images/CarouselThumbnails/resized/DaisyAndSheep.webp', link: '/animations/daisyandsheep', seasons: $author$project$Animations$DaisyAndSheep$DASEpisodes$seasons, thumbnail: '/assets/images/AnimationImageLinks/DaisyAndSheep.webp', title: 'Daisy and Sheep'},
		{
		about: A2($elm$html$Html$span, _List_Nil, _List_Nil),
...
var $author$project$FeastDayActivities$Main$NewTime = function (a) {
	return {$: 'NewTime', a: a};
};
var $author$project$FeastDayActivities$Main$NewZone = function (a) {
	return {$: 'NewZone', a: a};
};
var $author$project$FeastDayActivities$Main$SaintListMsg = function (a) {
	return {$: 'SaintListMsg', a: a};
};
var $author$project$Saints$SaintList$FetchData = function (a) {
...
var $author$project$Saints$SaintList$Response = function (values) {
	return {values: values};
};
var $elm$json$Json$Decode$array = _Json_decodeArray;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Saints$SaintList$responseDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Saints$SaintList$Response,
	A2(
		$elm$json$Json$Decode$field,
		'values',
		$elm$json$Json$Decode$array(
			$elm$json$Json$Decode$array($elm$json$Json$Decode$string))));
var $author$project$Saints$SaintList$fetchSaints = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Saints$SaintList$FetchData, $author$project$Saints$SaintList$responseDecoder),
		url: 'https://us-central1-catholic-stories-for-children.cloudfunctions.net/get-feast-day-activities'
	});
var $author$project$Saints$SaintList$init = {error: $elm$core$Maybe$Nothing, isLoading: true, saints: _List_Nil};
...
var $author$project$FeastDayActivities$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{
				key: key,
				saintList: $author$project$Saints$SaintList$init,
				signup: $author$project$Signup$init,
				time: $elm$time$Time$millisToPosix(0),
				timezone: $elm$time$Time$utc,
				url: url
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2($elm$core$Task$perform, $author$project$FeastDayActivities$Main$NewTime, $elm$time$Time$now),
						A2($elm$core$Task$perform, $author$project$FeastDayActivities$Main$NewZone, $elm$time$Time$here),
						A2($elm$core$Platform$Cmd$map, $author$project$FeastDayActivities$Main$SaintListMsg, $author$project$Saints$SaintList$fetchSaints)
					])));
	});
var $author$project$Saints$Main$Partial = {$: 'Partial'};
var $author$project$Saints$Main$SaintListMsg = function (a) {
	return {$: 'SaintListMsg', a: a};
};
var $author$project$Saints$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{key: key, patronageView: $author$project$Saints$Main$Partial, query: '', saintList: $author$project$Saints$SaintList$init, signup: $author$project$Signup$init, url: url},
			A2($elm$core$Platform$Cmd$map, $author$project$Saints$Main$SaintListMsg, $author$project$Saints$SaintList$fetchSaints));
	});
			...
			case 'LinkClicked':
				...
				if (urlRequest.$ === 'Internal') {
					...
					return isProductionsPage ? _Utils_Tuple2(
						_Utils_update(
							model,
							{url: url, videoDetailTab: $author$project$Animations$View$Episodes}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
...
var $author$project$FeastDayActivities$Main$SignupMsg = function (a) {
	return {$: 'SignupMsg', a: a};
};
...
var $author$project$FeastDayActivities$Main$NoOp = {$: 'NoOp'};
...
var $author$project$FeastDayActivities$Main$jumpToHeader = A2(
	$elm$core$Task$attempt,
	function (_v0) {
		return $author$project$FeastDayActivities$Main$NoOp;
	},
	A2(
		$elm$core$Task$andThen,
		function (i) {
			return A3($elm$browser$Browser$Dom$setViewportOf, 'body', 0, i.element.y);
		},
		$elm$browser$Browser$Dom$getElement('calendar-content')));
var $author$project$FeastDayActivities$Main$jumpToTop = A2(
	$elm$core$Task$attempt,
	function (_v0) {
		return $author$project$FeastDayActivities$Main$NoOp;
	},
	A2(
		$elm$core$Task$andThen,
		function (i) {
			return A3($elm$browser$Browser$Dom$setViewportOf, 'body', 0, 0);
		},
		$elm$browser$Browser$Dom$getElement('calendar-content')));
		...
		[
			...
			feasts: _List_fromArray(
				[
					...
					activities: _List_fromArray(
						[
							{activityType: $author$project$FeastDayActivities$FeastDayHelpers$Audio, image: '', link: 'https://castbox.fm/app/castbox/player/id4699401/id595842884?v=8.22.11&autoplay=0', snippet: '', title: ''}
						]),
...
var $author$project$Saints$SaintList$convertToSaint = function (saintData) {
	return {
		alternativeNames: A2(
			$elm$core$Maybe$withDefault,
			'',
...
var $author$project$Saints$SaintList$convertToSaintList = function (responseData) {
	return A3(
		...
		function (data) {
			return function (list) {
				return _Utils_ap(
					...
					_List_fromArray(
						[
							$author$project$Saints$SaintList$convertToSaint(data)
						]));
			};
		},
		_List_Nil,
...
var $author$project$Saints$SaintList$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Err') {
			return _Utils_Tuple2(
				_Utils_update(
			...
			return _Utils_Tuple2(
				_Utils_update(
					...
					{
						isLoading: false,
						saints: $author$project$Saints$SaintList$convertToSaintList(response)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$String$contains,
						'd=',
						$elm$url$Url$toString(url)) ? $author$project$FeastDayActivities$Main$jumpToTop : $author$project$FeastDayActivities$Main$jumpToHeader);
			case 'SignupMsg':
				var signupMsg = msg.a;
				var _v2 = A2($author$project$Signup$update, signupMsg, model.signup);
				var signup = _v2.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{signup: signup}),
					A2($elm$core$Platform$Cmd$map, $author$project$FeastDayActivities$Main$SignupMsg, cmd));
			case 'NewTime':
				var t = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'SaintListMsg':
				...
				var _v3 = A2($author$project$Saints$SaintList$update, saintListMsg, model.saintList);
				var newSaintList = _v3.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Saints$Main$SignupMsg = function (a) {
	return {$: 'SignupMsg', a: a};
};
var $author$project$Saints$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'LinkClicked':
				var urlRequest = msg.a;
			...
			case 'SignupMsg':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{signup: signup}),
					A2($elm$core$Platform$Cmd$map, $author$project$Saints$Main$SignupMsg, cmd));
			case 'SaintListMsg':
				var saintListMsg = msg.a;
				var _v3 = A2($author$project$Saints$SaintList$update, saintListMsg, model.saintList);
				var newSaintList = _v3.a;
		...
		switch (msg.$) {
			case 'LinkClicked':
				...
				if (urlRequest.$ === 'Internal') {
					var url = urlRequest.a;
					var urlString = $elm$url$Url$toString(url);
					return A2($elm$core$String$contains, 'joseph', urlString) ? _Utils_Tuple2(
						model,
						$elm$browser$Browser$Navigation$load('https://www.kickstarter.com/projects/catholicstories/saint-joseph-animation')) : (A2($elm$core$String$contains, 'animations', urlString) ? _Utils_Tuple2(
						_Utils_update(
							model,
						...
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								...
								]))) : (A2($elm$core$String$contains, 'navigation', urlString) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{page: $author$project$Main$Navigation, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$Give, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$Contact, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$AboutUs, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$Resources, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$Prayers, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$Angelus, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$Shop, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
						...
						_Utils_update(
							model,
							{page: $author$project$Main$Saints, url: url}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
			...
			case 'SaintsMsg':
				var saintsMsg = msg.a;
				var _v3 = A2($author$project$Saints$Main$update, saintsMsg, model.saintsPageModel);
				var updatedSaintsModel = _v3.a;
				var cmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'FeastsMsg':
				var feastsMsg = msg.a;
				var _v4 = A2($author$project$FeastDayActivities$Main$update, feastsMsg, model.feastsPageModel);
				var updatedFeastsModel = _v4.a;
				var cmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ProductionsMsg':
				...
				var _v5 = A2($author$project$Animations$View$update, productionsMsg, model.animationsPageModel);
				var updatedProductionsModel = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var urlString = $elm$url$Url$toString(url);
		var initialPage = A2($elm$core$String$contains, 'animations', urlString) ? $author$project$Main$Productions : (A2($elm$core$String$contains, 'navigation', urlString) ? $author$project$Main$Navigation : (A2($elm$core$String$contains, 'give', urlString) ? $author$project$Main$Give : (A2($elm$core$String$contains, 'contact', urlString) ? $author$project$Main$Contact : (A2($elm$core$String$contains, 'team', urlString) ? $author$project$Main$AboutUs : (A2($elm$core$String$contains, 'resources', urlString) ? $author$project$Main$Resources : (A2($elm$core$String$contains, 'prayers', urlString) ? $author$project$Main$Prayers : (A2($elm$core$String$contains, 'angelus', urlString) ? $author$project$Main$Angelus : (A2($elm$core$String$contains, 'shop', urlString) ? $author$project$Main$Shop : (A2($elm$core$String$contains, 'saints', urlString) ? $author$project$Main$Saints : $author$project$Main$Home)))))))));
		var _v0 = A3($author$project$Saints$Main$init, flags, url, key);
		var saintsPageModel = _v0.a;
		var saintsPageCmd = _v0.b;
		var _v1 = $author$project$Main$redirectUrl(url);
		var isRedirectedUrl = _v1.a;
		var newPath = _v1.b;
		var redirectedUrl = _v1.c;
		var _v2 = A3($author$project$FeastDayActivities$Main$init, flags, url, key);
		var feastsPageModel = _v2.a;
		var feastsPageCmd = _v2.b;
		var _v3 = A3($author$project$Animations$View$init, flags, url, key);
		var animationsPageModel = _v3.a;
		var animationsPageCmd = _v3.b;
		var initModel = {
		...
		var redirectedModel = _v4.a;
		var redirectedMsg = _v4.b;
		return _Utils_Tuple2(
			redirectedModel,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						A2($elm$core$Platform$Cmd$map, $author$project$Main$ProductionsMsg, animationsPageCmd),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$SaintsMsg, saintsPageCmd),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$FeastsMsg, feastsPageCmd),
						redirectedMsg
					])));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('mb-10 text-3xl md:text-7xl')
							]),
						_List_fromArray(
							[
...
var $author$project$Animations$View$viewSpecificEpisode = F4(
	function (model, productionURL, seasonURL, episodeUrl) {
		...
		if (((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) && (_v0.c.$ === 'Just')) {
			...
			return pageEpisode.isFundraising ? pageEpisode.about : A4($author$project$Animations$View$viewEpisode, model, production, season.number, pageEpisode);
		} else {
			return $author$project$Animations$View$viewProductions(model);
		}
	});
...
var $author$project$Footer$viewFooter = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('text-white py-20 px-20 space-y-6'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('flex space-x-6 pt-2')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://www.pinterest.com/catholicstoriesforchildren'),
							$elm$html$Html$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('text-lg pt-5')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Copyright © 2025 Claritas Studios. All rights reserved.')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('space-x-2 text-lg')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('underline hover:text-gray-300'),
...
var $author$project$Logo$logo = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$src('/assets/new_logo.png'),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-white logo-section-bg'),
			...
			body: _List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2(
							$author$project$Header$viewSubpageHeader,
							A2(
								$elm$core$String$join,
								' ',
								_List_fromArray(
									['Animations', title])),
							$author$project$Helpers$headerMargin),
...
var $author$project$Contact$View$viewContactInfo = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Contact$View$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$author$project$Contact$View$viewContactInfo
		]));
var $author$project$Contact$View$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Contact', $author$project$Helpers$headerMargin),
			$author$project$Contact$View$viewBody,
			$author$project$Footer$viewFooter
		]));
...
var $author$project$FeastDayActivities$Main$feastMonthFromMonth = function (month) {
	switch (month.$) {
		case 'Jan':
			return $author$project$FeastDayActivities$FeastDays$M01Jan$january;
		case 'Feb':
			return $author$project$FeastDayActivities$FeastDays$M02Feb$february;
		case 'Mar':
			return $author$project$FeastDayActivities$FeastDays$M03Mar$march;
		case 'Apr':
			return $author$project$FeastDayActivities$FeastDays$M04Apr$april;
		case 'May':
			return $author$project$FeastDayActivities$FeastDays$M05May$may;
		case 'Jun':
			return $author$project$FeastDayActivities$FeastDays$M06Jun$june;
		case 'Jul':
			return $author$project$FeastDayActivities$FeastDays$M07Jul$july;
		case 'Aug':
			return $author$project$FeastDayActivities$FeastDays$M08Aug$august;
		case 'Sep':
			return $author$project$FeastDayActivities$FeastDays$M09Sep$september;
		case 'Oct':
			return $author$project$FeastDayActivities$FeastDays$M10Oct$october;
		case 'Nov':
			return $author$project$FeastDayActivities$FeastDays$M11Nov$november;
		default:
			return $author$project$FeastDayActivities$FeastDays$M12Dec$december;
	}
};
...
var $author$project$FeastDayActivities$Main$monthFromTime = function (t) {
	return $author$project$FeastDayActivities$Main$feastMonthFromMonth(
...
var $author$project$FeastDayActivities$Main$createFeastDayLink = F2(
	function (month, date) {
		var paddedDate = A3(
			...
			_Utils_chr('0'),
			date);
		return $author$project$FeastDayActivities$Main$urlPath + ('?m=' + (month + ('&d=' + paddedDate)));
	});
var $author$project$FeastDayActivities$FeastDayHelpers$isLeapYear = function (year) {
	return ((!A2($elm$core$Basics$modBy, 4, year)) && (!(!A2($elm$core$Basics$modBy, 100, year)))) || (!A2($elm$core$Basics$modBy, 400, year));
};
var $author$project$FeastDayActivities$FeastDayHelpers$nextDate = F3(
	function (year, month, day) {
		...
		switch (month) {
			...
			case 'feb':
				return $author$project$FeastDayActivities$FeastDayHelpers$isLeapYear(intYear) ? (((date + 1) <= 29) ? _Utils_Tuple2(
					'feb',
...
var $author$project$FeastDayActivities$FeastDayHelpers$previousDate = F3(
	function (year, month, day) {
		var intYear = A2(
			$elm$core$Maybe$withDefault,
			0,
		...
		switch (month) {
			...
			case 'mar':
				return ((date - 1) > 0) ? _Utils_Tuple2(
					'mar',
					$elm$core$String$fromInt(date - 1)) : ($author$project$FeastDayActivities$FeastDayHelpers$isLeapYear(intYear) ? _Utils_Tuple2('feb', '29') : _Utils_Tuple2('feb', '28'));
			case 'apr':
				return ((date - 1) > 0) ? _Utils_Tuple2(
					'apr',
...
var $author$project$FeastDayActivities$FeastDayHelpers$activityDescriptionFromLink = F2(
...
var $author$project$FeastDayActivities$FeastDayHelpers$activityImageFromLink = function (link) {
...
var $author$project$FeastDayActivities$FeastDayHelpers$activityTitleFromLink = F2(
	function (saintName, link) {
...
var $author$project$FeastDayActivities$FeastDayHelpers$activityTypeFromLink = function (link) {
	return A2($elm$core$String$contains, 'catholicsaints.info', link) ? $author$project$FeastDayActivities$FeastDayHelpers$More : (A2($elm$core$String$contains, 'catholiccuisine', link) ? $author$project$FeastDayActivities$FeastDayHelpers$Food : (A2($elm$core$String$contains, 'catholic.org', link) ? $author$project$FeastDayActivities$FeastDayHelpers$OnlineReading : (A2($elm$core$String$contains, 'teachingcatholickids', link) ? $author$project$FeastDayActivities$FeastDayHelpers$OnlineReading : (A2($elm$core$String$contains, 'youtube', link) ? $author$project$FeastDayActivities$FeastDayHelpers$Video : (A2($elm$core$String$contains, 'swpals', link) ? $author$project$FeastDayActivities$FeastDayHelpers$Video : (A2($elm$core$String$contains, 'franciscanmedia', link) ? $author$project$FeastDayActivities$FeastDayHelpers$Audio : ((A2($elm$core$String$contains, 'saintsalivepodcast', link) || A2($elm$core$String$contains, 'podcasts', link)) ? $author$project$FeastDayActivities$FeastDayHelpers$Audio : (A2($elm$core$String$contains, 'christianiconography', link) ? $author$project$FeastDayActivities$FeastDayHelpers$Images : (A2($elm$core$String$contains, 'ucatholic', link) ? $author$project$FeastDayActivities$FeastDayHelpers$OnlineReading : (A2($elm$core$String$contains, 'thecatholickid', link) ? $author$project$FeastDayActivities$FeastDayHelpers$Printout : (A2($elm$core$String$contains, 'catholicfamilycrate', link) ? $author$project$FeastDayActivities$FeastDayHelpers$Printout : $author$project$FeastDayActivities$FeastDayHelpers$More)))))))))));
};
var $author$project$FeastDayActivities$FeastDayHelpers$activityFromLink = F2(
	function (saintName, link) {
		var activityType = $author$project$FeastDayActivities$FeastDayHelpers$activityTypeFromLink(link);
		var activityTitle = A2($author$project$FeastDayActivities$FeastDayHelpers$activityTitleFromLink, saintName, link);
		var activityImage = $author$project$FeastDayActivities$FeastDayHelpers$activityImageFromLink(link);
		var activityDescription = A2($author$project$FeastDayActivities$FeastDayHelpers$activityDescriptionFromLink, saintName, link);
...
var $author$project$Saints$SaintHelpers$activitiesFromSaint = function (saint) {
	return A2(
		$elm$core$List$filterMap,
		function (_v0) {
			var saintName = _v0.a;
			...
			_List_fromArray(
				[
					...
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.catholicOrgVideoLink))
					]) : _List_Nil,
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.catholicSaintsInfoYoutubePlaylist))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.catholicCuisine))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.christianiconographyInfo))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.catholicSprouts))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.franciscanMediaLink))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.teachingCatholicKidsLink))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.catholicOrgLink))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.catholicSaintsLink))
					]),
					_List_fromArray(
					[
						_Utils_Tuple2(
						saint.name,
						A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, saint.uCatholicLink))
					]),
					A2(
					$elm$core$List$map,
					function (link) {
						return _Utils_Tuple2(
							saint.name,
							A2($author$project$FeastDayActivities$FeastDayHelpers$activityFromLink, saint.name, link));
					},
...
var $author$project$Spinner$purpleSpinner = function (attributes) {
	return A2(
		$elm$svg$Svg$svg,
		_Utils_ap(
			_List_fromArray(
...
var $author$project$FeastDayActivities$FeastDayHelpers$viewActivities = F2(
		...
		return $elm$core$List$isEmpty(activities) ? A2($elm$html$Html$span, _List_Nil, _List_Nil) : A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$div,
					_List_Nil,
					A2($elm$core$List$map, $author$project$FeastDayActivities$FeastDayHelpers$viewActivity, activities))
				]));
	});
var $author$project$FeastDayActivities$FeastDayHelpers$viewEmbeddedAudio = function (activity) {
...
var $author$project$FeastDayActivities$FeastDayHelpers$viewAudio = function (audio) {
	return A2($elm$core$String$contains, 'embed', audio.link) ? $author$project$FeastDayActivities$FeastDayHelpers$viewEmbeddedAudio(audio) : $author$project$FeastDayActivities$FeastDayHelpers$viewActivity(audio);
};
var $author$project$FeastDayActivities$FeastDayHelpers$viewAudioList = function (audioList) {
	return $elm$core$List$isEmpty(audioList) ? A2($elm$html$Html$span, _List_Nil, _List_Nil) : A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$FeastDayActivities$FeastDayHelpers$viewAudio, audioList))
			]));
};
var $author$project$FeastDayActivities$FeastDayHelpers$viewNoActivities = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$FeastDayActivities$FeastDayHelpers$viewPrintout = function (activity) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
...
var $author$project$FeastDayActivities$FeastDayHelpers$viewPrintouts = F2(
	function (title, activities) {
		return $elm$core$List$isEmpty(activities) ? A2($elm$html$Html$span, _List_Nil, _List_Nil) : A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$map,
						function (activity) {
							return $author$project$FeastDayActivities$FeastDayHelpers$viewPrintout(activity);
						},
						activities))
				]));
	});
var $author$project$FeastDayActivities$FeastDayHelpers$viewEmbeddedVideo = function (video) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$FeastDayActivities$FeastDayHelpers$viewVideo = function (video) {
	return A2($elm$core$String$contains, 'embed', video.link) ? $author$project$FeastDayActivities$FeastDayHelpers$viewEmbeddedVideo(video) : $author$project$FeastDayActivities$FeastDayHelpers$viewActivity(video);
};
var $author$project$FeastDayActivities$FeastDayHelpers$viewVideos = function (videos) {
				...
				A2(
					...
					function (video) {
						return A2(
							...
							_List_fromArray(
								[
									$author$project$FeastDayActivities$FeastDayHelpers$viewVideo(video)
								]));
					},
					videos))
			]));
};
var $author$project$FeastDayActivities$FeastDayHelpers$viewAllActivities = F2(
		...
		return isLoading ? A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Spinner$purpleSpinner(_List_Nil)
						]))
			...
			_List_fromArray(
				[$author$project$FeastDayActivities$FeastDayHelpers$viewNoActivities])) : A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$author$project$FeastDayActivities$FeastDayHelpers$viewVideos(
					$author$project$FeastDayActivities$FeastDayHelpers$videoActivities(activities)),
					$author$project$FeastDayActivities$FeastDayHelpers$viewAudioList(
					$author$project$FeastDayActivities$FeastDayHelpers$audioActivities(activities)),
					A2(
					$author$project$FeastDayActivities$FeastDayHelpers$viewActivities,
					'Crafts to Do',
					$author$project$FeastDayActivities$FeastDayHelpers$craftActivities(activities)),
					A2(
					$author$project$FeastDayActivities$FeastDayHelpers$viewPrintouts,
					'Printouts to Enjoy',
...
var $author$project$FeastDayActivities$Main$viewFeastActivities = F2(
	function (model, feastActivitiesList) {
		...
		var saintActivities = A2(
			...
			removeDuplicates(
				A2(
					$elm$core$List$concatMap,
					$author$project$Saints$SaintHelpers$activitiesFromSaint,
					A2(
						$elm$core$List$filter,
						function (saint) {
							return A2(
...
var $author$project$FeastDayActivities$Main$viewFeastDayHeader = function (feasts) {
	var concatFeasts = A2(
		...
		A2(
			...
			feasts));
	return (concatFeasts === '') ? A2($elm$html$Html$span, _List_Nil, _List_Nil) : A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('grid m-auto')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$FeastDayActivities$Main$viewWeekdayActivities = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$FeastDayActivities$Main$viewDate = F4(
	function (model, month, date, feasts) {
		var _v0 = A3($author$project$FeastDayActivities$FeastDayHelpers$previousDate, '2024', month, date);
		var prevMonth = _v0.a;
		var prevDay = _v0.b;
		var prevDateLink = A2($author$project$FeastDayActivities$Main$createFeastDayLink, prevMonth, prevDay);
		var _v1 = A3($author$project$FeastDayActivities$FeastDayHelpers$nextDate, '2024', month, date);
		var nextMonth = _v1.a;
		var nextDay = _v1.b;
		var nextDateLink = A2($author$project$FeastDayActivities$Main$createFeastDayLink, nextMonth, nextDay);
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-center'),
							$elm$html$Html$Attributes$class('mt-10 max-w-3xl mx-auto px-11'),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('grid grid-cols-3 mb-16')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-7xl text-left md:m-0'),
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-7xl text-left m-5 md:m-0 justify-self-center'),
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-7xl text-left md:m-0 justify-self-end'),
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('capitalize text-left')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															$elm$html$Html$text('Catholic Activities for Children')
														])),
													A2(
													$elm$html$Html$span,
													_List_fromArray(
													...
													_List_fromArray(
														[
															$elm$html$Html$text('for ' + (month + (' ' + (date + ', 2024'))))
														]))
												])),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm$html$Html$map, $author$project$FeastDayActivities$Main$SignupMsg, $author$project$Signup$view4)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									A2($author$project$FeastDayActivities$Main$viewFeastActivities, model, feasts),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[$author$project$FeastDayActivities$Main$viewWeekdayActivities]))
								]))
						]))
				]));
	});
...
var $author$project$FeastDayActivities$Main$viewFeastDay = F2(
	function (month, feastDay) {
		var link = A2($author$project$FeastDayActivities$Main$createFeastDayLink, month, feastDay.date);
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class('rounded'),
					A2($elm$html$Html$Attributes$style, 'font-family', 'hvdComicSerifPro'),
					A2($elm$html$Html$Attributes$style, 'background-color', '#9de3ec'),
...
var $author$project$FeastDayActivities$Main$viewMonthPillBox = F2(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$String$contains,
						month,
						$elm$core$String$toLower(currentMonth)) ? 'bg-csc-darkblue text-white' : ''),
					$elm$html$Html$Attributes$class('hover:bg-csc-lightblue hover:text-black'),
					$elm$html$Html$Attributes$class('rounded'),
					$elm$html$Html$Attributes$class('p-2'),
...
var $author$project$FeastDayActivities$Main$viewMonth = F2(
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('2024 Feast Day Activities')
										])) : A2(
									$elm$html$Html$h1,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('grid grid-cols-6 lg:grid-cols-12 gap-y-2 justify-items-center'),
									$elm$html$Html$Attributes$class('text-3xl md:text-3xl lg:text-3xl'),
							...
							A2(
								$elm$core$List$map,
								$author$project$FeastDayActivities$Main$viewMonthPillBox(feastMonth.month),
								$author$project$FeastDayActivities$FeastDays$months)),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
...
var $author$project$FeastDayActivities$Main$viewBody = F2(
	function (model, route) {
		var defaultMonth = $author$project$FeastDayActivities$Main$monthFromTime(model.time);
		if (route.$ === 'Just') {
			var date = route.a.a;
			...
			if (_v1.a.$ === 'Just') {
				if (_v1.b.$ === 'Just') {
					...
					var _v2 = _v1.b;
					return A2(
						$author$project$FeastDayActivities$Main$viewMonth,
						model,
						A2(
							$elm$core$Maybe$withDefault,
							defaultMonth,
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$FeastDayActivities$Main$viewBody, model, currentRoute),
						$author$project$Footer$viewFooter
					]))
			]),
...
var $author$project$Give$View$donateAbout = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Here at Catholic Stories for Children, we are passionate Catholic educators dedicated to helping children grow in their love for God and neighbor. Through creative, faith-based animations, we make Catholic teachings come alive in a fun and meaningful way for kids. Every child deserves the chance to learn and deepen their faith.')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
...
var $author$project$Give$View$donateSection = F3(
...
var $author$project$Give$View$donateWithVehicle = A3(
	$author$project$Give$View$donateSection,
	'Donate Your Vehicle',
...
var $author$project$Give$View$prayForUs = A3(
	$author$project$Give$View$donateSection,
	'Pray for us',
	'',
	A2(
...
var $author$project$Give$View$sponsor = A3(
	$author$project$Give$View$donateSection,
	'Sponsorship',
	'',
	A2(
...
var $author$project$Give$View$supportNextAnimation = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Give$View$volunteer = A3(
	$author$project$Give$View$donateSection,
	'Volunteer',
	'',
	A2(
...
var $author$project$Give$View$wordsOfEncouragement = A3(
	$author$project$Give$View$donateSection,
...
var $author$project$Give$View$viewBody = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src('/assets/images/CarouselThumbnails/HailMary.png'),
					$elm$html$Html$Attributes$alt('Hail Mary animation')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					$author$project$Give$View$donateAbout,
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[$author$project$Give$View$supportNextAnimation])),
					A2(
					$elm$html$Html$h2,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[$author$project$Give$View$prayForUs, $author$project$Give$View$donateWithVehicle, $author$project$Give$View$sponsor, $author$project$Give$View$volunteer, $author$project$Give$View$wordsOfEncouragement]))
				]))
		]));
var $author$project$Give$View$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('bg-[#fef7f4]')
	...
	_List_fromArray(
		[$author$project$Give$View$viewBody, $author$project$Footer$viewFooter]));
var $elm$core$Basics$clamp = F3(
	function (low, high, number) {
		return (_Utils_cmp(number, low) < 0) ? low : ((_Utils_cmp(number, high) > 0) ? high : number);
	});
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$Navigation$View$viewNavButton = F4(
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href(link),
					$elm$html$Html$Attributes$class('hover:bg-csc-lightpurple'),
					$elm$html$Html$Attributes$class('px-10 py-5'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('px-10 m-auto')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(page)
...
var $author$project$Navigation$View$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('min-h-screen'),
	...
	_List_fromArray(
		[
			A4($author$project$Navigation$View$viewNavButton, 1, '_self', '/', 'Home'),
			A4($author$project$Navigation$View$viewNavButton, 2, '_self', '/feastdayactivities', 'Calendar'),
			A4($author$project$Navigation$View$viewNavButton, 3, '_self', '/saints', 'Saints'),
			A4($author$project$Navigation$View$viewNavButton, 4, '_self', '/animations', 'Animations'),
			A4($author$project$Navigation$View$viewNavButton, 5, '_self', '/resources', 'Resources'),
			A4($author$project$Navigation$View$viewNavButton, 6, '_self', '/shop', 'Shop'),
			A4($author$project$Navigation$View$viewNavButton, 7, '_blank', 'https://blog.catholicstoriesforchildren.com/', 'Blog'),
			A4($author$project$Navigation$View$viewNavButton, 8, '_self', '/give', 'Donate'),
			A4($author$project$Navigation$View$viewNavButton, 9, '_self', '/team', 'About Us')
		]));
...
var $author$project$Prayer$Angelus$View$viewAboutTheAngelus = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Prayer$Angelus$View$viewAngelusPrayer = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Prayer$Angelus$View$viewAngelusPrayerVideo = A2($author$project$Animations$Helpers$viewVideo, '', 'https://www.youtube-nocookie.com/embed/-r6ChB56gr4');
var $author$project$Prayer$Angelus$View$viewAngelusPage = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('max-w-3xl')
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$author$project$Prayer$Angelus$View$viewAboutTheAngelus])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[$author$project$Prayer$Angelus$View$viewAngelusPrayerVideo])),
			A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[$author$project$Prayer$Angelus$View$viewAngelusPrayer]))
		]));
var $author$project$Prayer$Angelus$View$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('bg-[#FEF7F4]'),
	...
	_List_fromArray(
		[
			...
			$author$project$Prayer$Angelus$View$viewAngelusPage
		]));
var $author$project$Prayer$Angelus$View$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Prayers', $author$project$Helpers$headerMargin),
			$author$project$Prayer$Angelus$View$viewBody,
			$author$project$Footer$viewFooter
		]));
var $elm$html$Html$details = _VirtualDom_node('details');
var $elm$html$Html$summary = _VirtualDom_node('summary');
var $author$project$Prayers$View$viewSaints = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Prayers$View$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('bg-[#FEF7F4]'),
	...
	_List_fromArray(
		[
			...
			$author$project$Prayers$View$viewSaints
		]));
var $author$project$Prayers$View$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Prayers', $author$project$Helpers$headerMargin),
			$author$project$Prayers$View$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Resources$Books$brotherFrancisBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/16_V1sLznRg0.png?updatedAt=1679070333303', link: 'https://brotherfrancisstore.com/collections/books', name: 'Brother Francis Books'};
var $author$project$Resources$Books$cBPSaints = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/38_oB0pzZnMW8.png?updatedAt=1682716506417', link: 'https://catholicbookpublishing.com/browse/childrens-books-on-saints', name: 'Catholic Book Publishing\'s Children\'s Books on Saints'};
var $author$project$Resources$Books$catholicSprouts = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/26_2TkstMXTY.png?updatedAt=1682716507634', link: 'https://shop.catholicsprouts.com/collections/all', name: 'Catholic Sprouts Books and Materials'};
var $author$project$Resources$Books$ctbBooks = {image: '/assets/images/ProfilePictures/CatholicTeenBooks.png', link: 'https://www.catholicteenbooks.com/', name: 'Catholic Teen Books'};
var $author$project$Resources$Books$ctsBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/CTS_Logo_vwbekKAI-.png?updatedAt=1687667974185', link: 'https://www.ctsbooks.org/product-category/children-young-adults/', name: 'Catholic Truth Society'};
var $author$project$Resources$Books$diaryOfAGodMan = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/27_LJ8rjMXH6.png?updatedAt=1682716507484', link: 'https://www.diaryofagodman.com/books', name: 'Diary of a God-Man. A fully illustrated children\'s missal'};
var $author$project$Resources$Books$ewtnKidsBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/30_SPGrEpxn4o.png?updatedAt=1682716506374', link: 'https://www.ewtnreligiouscatalogue.com/Catholic-Childrens-Books', name: 'EWTN Childrens Books'};
var $author$project$Resources$Books$firstFaithTreasury = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/33_v8d9TN1XkY.png?updatedAt=1682716506330', link: 'https://firstfaithtreasury.com/', name: 'First Faith Treasury'};
var $author$project$Resources$Books$holyHeroesBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/25_OSP8-2xFJ.png?updatedAt=1682716507604', link: 'https://holyheroes.com/collections/catholic-childrens-books', name: 'Holy Heroes Books'};
var $author$project$Resources$Books$jennaEpkey = {image: '/assets/images/ProfilePictures/JennaEpkey.png', link: 'https://www.amazon.com/stores/Jenna-Epkey/author/B0CWPDDMRM', name: 'Jenna Epkey Catholic Kids Books'};
var $author$project$Resources$Books$lightOfTheSaints = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/36_eINHZkemx9.png?updatedAt=1682716506020', link: 'https://bookstore.wordonfire.org/products/light-of-the-saints', name: 'Light of the Saints'};
var $author$project$Resources$Books$littleSaintStories = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/34_GtSZ5NI8_8.png?updatedAt=1682716506395', link: 'https://www.littlesaintstories.com/s/shop', name: 'Little Saint Stories'};
var $author$project$Resources$Books$loyolaPressBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/23_UvXPxYgqml.png?updatedAt=1682716507758', link: 'https://www.loyolapress.com/', name: 'Loyola Press Books'};
var $author$project$Resources$Books$osvKidsBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/3rd_Party_Logos_DxY5MCRoK.png?updatedAt=1682716853025', link: 'https://osvkids.com/books/', name: 'OSV Kids Books'};
var $author$project$Resources$Books$paulineBooksAndMediaForKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/37_gMX8cczFD.png?updatedAt=1682716506298', link: 'https://paulinestore.com/kids-teens.html', name: 'Pauline Books and Media'};
var $author$project$Resources$Books$stPaulCenter = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/35_evg05JJAFh.png?updatedAt=1682716506043', link: 'https://stpaulcenter.com/product-category/children/', name: 'St Paul Center Children\'s Books'};
var $author$project$Resources$Books$tanBooks = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/32_22z_5JUPjM.png?updatedAt=1682716506412', link: 'https://tanbooks.com/catholic-kids-books/', name: 'Tan Books for Kids'};
var $author$project$Resources$Books$theLittleRoseShop = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/29_9r_mR-lb6.png?updatedAt=1682716506911', link: 'https://thelittleroseshop.com/collections/baby-kids', name: 'The Little Rose Shop Fabric Books'};
var $author$project$Resources$Books$theotokosKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/28_INemNiAcr.png?updatedAt=1682716507584', link: 'https://theotokoskids.com/collections/books', name: 'Theotokos Kids Books'};
var $author$project$Resources$Books$thyOliveTree = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/24_ok9wTkcFo.png?updatedAt=1682716507750', link: 'https://www.thyolivetree.com/collections/childrens', name: 'Thy Olive Tree'};
var $author$project$Resources$Books$books = _List_fromArray(
	[$author$project$Resources$Books$littleSaintStories, $author$project$Resources$Books$theotokosKids, $author$project$Resources$Books$osvKidsBooks, $author$project$Resources$Books$theLittleRoseShop, $author$project$Resources$Books$brotherFrancisBooks, $author$project$Resources$Books$thyOliveTree, $author$project$Resources$Books$lightOfTheSaints, $author$project$Resources$Books$firstFaithTreasury, $author$project$Resources$Books$tanBooks, $author$project$Resources$Books$ctsBooks, $author$project$Resources$Books$ewtnKidsBooks, $author$project$Resources$Books$diaryOfAGodMan, $author$project$Resources$Books$catholicSprouts, $author$project$Resources$Books$holyHeroesBooks, $author$project$Resources$Books$jennaEpkey, $author$project$Resources$Books$loyolaPressBooks, $author$project$Resources$Books$stPaulCenter, $author$project$Resources$Books$cBPSaints, $author$project$Resources$Books$paulineBooksAndMediaForKids, $author$project$Resources$Books$ctbBooks]);
var $author$project$Resources$View$books = {description: 'Find books here. It\'s hard to go wrong with a good Catholic book.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/2_4YvKGvP_Y.png?updatedAt=1679066449106', link: '/resources/books', name: 'Books', resources: $author$project$Resources$Books$books};
var $author$project$Resources$Games$brotherFrancisGames = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/16_V1sLznRg0.png?updatedAt=1679070333303', link: 'https://brotherfrancisstore.com/collections/games', name: 'Brother Francis Games'};
var $author$project$Resources$Games$catholicArcade = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/64_P-dJU3ooLI.png?updatedAt=1693439790261', link: 'https://opusjoyous.com/', name: 'Catholic Arcade'};
var $author$project$Resources$Games$councilAtDaybreak = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/CouncilAtDaybreak_zY9pkcPisJ.png?updatedAt=1693440036474', link: 'https://catholiccardgame.com/collections/base-games/products/council-at-daybreak', name: 'Council At Daybreak'};
var $author$project$Resources$Games$holyHeroes = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/25_OSP8-2xFJ.png?updatedAt=1682716507604', link: 'https://holyheroes.com/collections/games', name: 'Holy Heroes Games'};
var $author$project$Resources$Games$superSaintCards = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/63_d1sooSovJJ.png?updatedAt=1693439790316', link: 'https://armadei.com/product/super-saints/', name: 'Super Saint Cards'};
var $author$project$Resources$Games$theCatholicCardGame = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/61_gGyNBdFEh.png?updatedAt=1693439790210', link: 'https://catholiccardgame.com/', name: 'The Catholic Card Game'};
var $author$project$Resources$Games$wanderlight = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/60_2jdg0x5pz.png?updatedAt=1693439790279', link: 'https://www.wanderlightgame.com/', name: 'Wanderlight'};
var $author$project$Resources$Games$games = _List_fromArray(
	[$author$project$Resources$Games$wanderlight, $author$project$Resources$Games$theCatholicCardGame, $author$project$Resources$Games$councilAtDaybreak, $author$project$Resources$Games$holyHeroes, $author$project$Resources$Games$brotherFrancisGames, $author$project$Resources$Games$superSaintCards, $author$project$Resources$Games$catholicArcade]);
var $author$project$Resources$View$games = {description: 'Find game resources for a fun way to learn about the Catholic faith', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/Game%20Icon_rb2djF7Hf.png?updatedAt=1693438195519', link: '/resources/games', name: 'Games', resources: $author$project$Resources$Games$games};
var $author$project$Resources$Podcasts$bibleInAYearWithTeddy = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/kidsbibleinayearwithteddy_dLisfpvYA.png?updatedAt=1689211660566', link: 'https://podcasts.apple.com/us/podcast/kids-bible-in-a-year-with-teddy/id1676869671', name: 'Kids Bible in a Year with Teddy'};
var $author$project$Resources$Podcasts$catholicKidsPodcast = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/3rd_Party_Logos_Mz1VR_PBx.png?updatedAt=1679071655063', link: 'https://podcasts.apple.com/us/podcast/catholic-kids-podcast/id1557527100', name: 'Catholic Kids Podcast'};
var $author$project$Resources$Podcasts$catholicKidsTriviaPodcast = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/CatholicKidsTriviaPodcast_rFHEiGK88.png?updatedAt=1679071809107', link: 'https://podcasts.apple.com/us/podcast/catholic-kids-trivia-podcast/id1662532400', name: 'Catholic Kids Trivia Podcast'};
var $author$project$Resources$Podcasts$catholicSprouts = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/11_HUKazDTNih.png?updatedAt=1679069711765', link: 'https://podcasts.apple.com/ca/podcast/catholic-sprouts-daily-podcast-for-catholic-kids/id1406174660', name: 'Catholic Sprouts'};
var $author$project$Resources$Podcasts$onTheNightTrain = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/On_The_Night_Train_Uy2SqRG8B.png?updatedAt=1679069840295', link: 'https://podcasts.apple.com/us/podcast/on-the-night-train/id1638922447', name: 'On The Night Train'};
var $author$project$Resources$Podcasts$saintStoriesForKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/10_W0OwjM8Yu.png?updatedAt=1679069711783', link: 'https://podcasts.apple.com/ca/podcast/saint-stories-for-kids/id1448514363', name: 'Saint Stories for Kids'};
var $author$project$Resources$Podcasts$saintsAlive = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/14_Aps0ku8wH.png?updatedAt=1679069710842', link: 'https://podcasts.apple.com/us/podcast/saints-alive-podcast/id1598392451', name: 'Saints Alive'};
var $author$project$Resources$Podcasts$thatsTheWord = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/12_NwOXTTpkTi.png?updatedAt=1679069710890', link: 'https://podcasts.apple.com/us/podcast/thats-the-word-with-fr-james-yamauchi/id1540449749', name: 'That\'s the word'};
var $author$project$Resources$Podcasts$theSaints = {image: '/assets/images/TheSaints.png', link: 'https://themerrybeggars.com/shows/the-saints', name: 'The Saints'};
var $author$project$Resources$Podcasts$podcasts = _List_fromArray(
	[$author$project$Resources$Podcasts$saintStoriesForKids, $author$project$Resources$Podcasts$catholicSprouts, $author$project$Resources$Podcasts$saintsAlive, $author$project$Resources$Podcasts$theSaints, $author$project$Resources$Podcasts$bibleInAYearWithTeddy, $author$project$Resources$Podcasts$thatsTheWord, $author$project$Resources$Podcasts$onTheNightTrain, $author$project$Resources$Podcasts$catholicKidsPodcast, $author$project$Resources$Podcasts$catholicKidsTriviaPodcast]);
var $author$project$Resources$View$podcasts = {description: 'Find audio podcasts here. Your kids can listen to them while on the road, traveling, while doing coloring activities, or they can be simply enjoyed by themselves.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/1_EAfo23y5R.png?updatedAt=1679066451335', link: '/resources/podcasts', name: 'Podcasts', resources: $author$project$Resources$Podcasts$podcasts};
var $author$project$Resources$Subscriptions$catholicFamilyCrate = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/7_i5fOMR9CEB.png?updatedAt=1685581542221', link: 'https://catholicfamilycrate.com', name: 'Catholic Family Crate'};
var $author$project$Resources$Subscriptions$diaryOfAGodman = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/27_LJ8rjMXH6.png?updatedAt=1682716507484', link: 'https://www.diaryofagodman.com/subscriptions', name: 'Diary of a God-Man'};
var $author$project$Resources$Subscriptions$faithAndFamilyCollective = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/6_tZqBkQ3sW.png?updatedAt=1685581578667', link: 'https://faithandfamilycollective.com', name: 'Faith + Family Collective'};
var $author$project$Resources$Subscriptions$formed = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/9_6wjdaJHdc.png?updatedAt=1685581568223', link: 'https://formed.org', name: 'Formed'};
var $author$project$Resources$Subscriptions$magnifiKid = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/8_qucgsetg84.png?updatedAt=1685581652225', link: 'https://us.magnificat.net/home/magnifikid', name: 'MagnifiKid'};
var $author$project$Resources$Subscriptions$massBox = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/5_GX7izsR5Jp.png?updatedAt=1685581558288', link: 'https://themassbox.com', name: 'Mass Box'};
var $author$project$Resources$Subscriptions$osvKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/3_1__qbNDjJEy1.png?updatedAt=1685581657645', link: 'https://osvkids.com/magazine/', name: 'OSV Kids Magazine'};
var $author$project$Resources$Subscriptions$saintOfTheMonth = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/4_1__LjeiFaCGM1.png?updatedAt=1685581640310', link: 'https://www.saintofthemonth.com', name: 'Saint of the Month Box'};
var $author$project$Resources$Subscriptions$subscriptions = _List_fromArray(
	[$author$project$Resources$Subscriptions$osvKids, $author$project$Resources$Subscriptions$saintOfTheMonth, $author$project$Resources$Subscriptions$massBox, $author$project$Resources$Subscriptions$faithAndFamilyCollective, $author$project$Resources$Subscriptions$catholicFamilyCrate, $author$project$Resources$Subscriptions$magnifiKid, $author$project$Resources$Subscriptions$formed, $author$project$Resources$Subscriptions$diaryOfAGodman]);
var $author$project$Resources$View$subscriptions = {description: 'Want monthly content at your front door? Check out these wonderful Catholic subscriptions.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/4_U5qO_iICx.png?updatedAt=1679066449068', link: '/resources/subscriptions', name: 'Subscriptions', resources: $author$project$Resources$Subscriptions$subscriptions};
var $author$project$Resources$Videos$amyheysart = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/AmyH_ld3G4EoVX.png?updatedAt=1692735921831', link: 'https://www.youtube.com/@amyheyseart', name: 'Amy Heyse Art'};
var $author$project$Resources$Videos$brotherFrancis = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/16_V1sLznRg0.png?updatedAt=1679070333303', link: 'https://www.youtube.com/@BrotherFrancis', name: 'Brother Francis'};
var $author$project$Resources$Videos$catholicIcing = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/41_XrkKmwtXL.png?updatedAt=1682876930378', link: 'https://www.youtube.com/@CatholicIcing', name: 'Catholic Icing'};
var $author$project$Resources$Videos$catholicKidsMedia = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/17_z9ZERCAuK.png?updatedAt=1679070333348', link: 'https://www.youtube.com/@CatholicKidsMedia', name: 'Catholic Kids Media'};
var $author$project$Resources$Videos$catholicSongsForKids = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/40_vS6tZTdD3.png?updatedAt=1682876930344', link: 'https://www.youtube.com/@catholicsongsforkids', name: 'Catholic Songs for Kids'};
var $author$project$Resources$Videos$catholicStoriesForChildren = {image: 'https://ik.imagekit.io/catholicstories/CSCLogo_JiNT9WUPX.png?updatedAt=1679070448402', link: 'https://www.youtube.com/@CatholicStoriesforChildren', name: 'Catholic Stories For Children'};
var $author$project$Resources$Videos$christineInAction = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/christineinaction_Le5_7yr2K.jpeg?updatedAt=1682821244341', link: 'https://www.youtube.com/@ChristineInAction', name: 'Christine In Action'};
var $author$project$Resources$Videos$heidiWitte = {image: '/assets/images/HeidiWitte.png', link: 'https://www.youtube.com/@kidsliturgy', name: 'Heidi Witte'};
var $author$project$Resources$Videos$juiceBox = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/juicebox_flQW7t8YD.png?updatedAt=1692736674561', link: 'https://www.youtube.com/@SpiritJuiceKids', name: 'Spirit Juice Kids'};
var $author$project$Resources$Videos$opusJoyous = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/opusjoyouslogo__bVhpC3Fj.jpeg?updatedAt=1687549207653', link: 'https://www.youtube.com/@OpusJoyous', name: 'Opus Joyous'};
var $author$project$Resources$Videos$prostradaDesigns = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/42_GMJuNZEVs.png?updatedAt=1683226627331', link: 'https://www.youtube.com/@prostradadesignsllc', name: 'Prostrada Designs'};
var $author$project$Resources$Videos$sacredHeartofJesusConvent = {image: '/assets/images/SacredHeartofJesusConvent.png', link: 'https://www.youtube.com/@SacredHeartofJesusConvent/about', name: 'Sacred Heart of Jesus Convent'};
var $author$project$Resources$Videos$tomkin = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/15_Wrw3_kbKK.png?updatedAt=1679070333309', link: 'https://www.youtube.com/playlist?list=PL9CQlldupc5_L0shwBi1w-n5liWhD0ArO', name: 'Tomkin'};
var $author$project$Resources$Videos$videos = _List_fromArray(
	[$author$project$Resources$Videos$catholicStoriesForChildren, $author$project$Resources$Videos$christineInAction, $author$project$Resources$Videos$tomkin, $author$project$Resources$Videos$juiceBox, $author$project$Resources$Videos$catholicKidsMedia, $author$project$Resources$Videos$brotherFrancis, $author$project$Resources$Videos$amyheysart, $author$project$Resources$Videos$heidiWitte, $author$project$Resources$Videos$sacredHeartofJesusConvent, $author$project$Resources$Videos$catholicSongsForKids, $author$project$Resources$Videos$opusJoyous, $author$project$Resources$Videos$catholicIcing, $author$project$Resources$Videos$prostradaDesigns]);
var $author$project$Resources$View$videos = {description: 'Find video content here. Videos are a wonderful engaging way to bring a visual representation of the faith into your home.', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/3_mTKsUZQuM.png?updatedAt=1679066450272', link: '/resources/videos', name: 'Youtube Channels', resources: $author$project$Resources$Videos$videos};
var $author$project$Resources$Prayer$Main$viewAboutPrayerResources = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Resources$Prayer$Main$theAmenApp = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/44_A3rkyg807.png?updatedAt=1683227692705', link: 'https://amenapp.org/', name: 'The Amen Prayer App'};
var $author$project$Resources$Prayer$Main$theHallowApp = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/45_n7tIe7YkV.png?updatedAt=1683227692949', link: 'https://hallow.com/', name: 'The Hallow Prayer App'};
var $author$project$Resources$Prayer$Main$twoByTwo = {image: 'https://ik.imagekit.io/catholicstories/ProfileImages/twobytwo_jqaTekz8M.png?updatedAt=1683228056777', link: 'https://twobytwoprayer.com/', name: 'Two by two Prayer Website'};
var $author$project$Resources$Helpers$viewResource = function (resource) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
...
var $author$project$Resources$Prayer$Main$viewPrayerResources = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
		...
		_List_fromArray(
			[$author$project$Resources$Prayer$Main$theHallowApp, $author$project$Resources$Prayer$Main$theAmenApp, $author$project$Resources$Prayer$Main$twoByTwo])));
var $author$project$Resources$Prayer$Main$viewPrayerSteps = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Resources$Prayer$Main$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('max-w-3xl'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$author$project$Signup$view4])),
			$author$project$Resources$Prayer$Main$viewAboutPrayerResources,
			$author$project$Resources$Prayer$Main$viewPrayerResources,
			$author$project$Resources$Prayer$Main$viewPrayerSteps
		]));
var $author$project$Resources$Prayer$Main$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'height', '100vh'),
	...
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Prayer Resources', $author$project$Helpers$headerMargin),
			$author$project$Resources$Prayer$Main$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Resources$View$viewAboutResources = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Resources$View$feastDayActivities = {description: 'Find activities for feast days throughout the year', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/feastdaycalendar_1__YTmPRisXH.png?updatedAt=1686096632436', link: '/feastdayactivities', name: 'Feast Day Activities', resources: _List_Nil};
var $author$project$Resources$View$prayerResources = {description: 'Find more resources here to help build your prayer life', image: 'https://ik.imagekit.io/catholicstories/Resources_Icons/prayerresources_gN76-j6pz.png?updatedAt=1683227269863', link: '/resources/prayer', name: 'Prayer Resources', resources: _List_Nil};
var $author$project$Resources$View$viewResourceGroup = function (resourceGroup) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
...
var $author$project$Resources$View$viewResourceGroups = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
		$author$project$Resources$View$viewResourceGroup,
		_List_fromArray(
			[$author$project$Resources$View$books, $author$project$Resources$View$podcasts, $author$project$Resources$View$videos, $author$project$Resources$View$subscriptions, $author$project$Resources$View$prayerResources, $author$project$Resources$View$feastDayActivities, $author$project$Resources$View$games])));
var $author$project$Resources$View$viewBody = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Resources$View$viewAboutResources
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[$author$project$Resources$View$viewResourceGroups]))
		]));
var $author$project$Resources$View$viewResources = function (resourceGroup) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Resources$Helpers$viewResource, resourceGroup.resources))
			]));
};
var $author$project$Resources$View$view = function (url) {
	var urlString = $elm$url$Url$toString(url);
	return A2($elm$core$String$contains, 'books', urlString) ? $author$project$Resources$View$viewResources($author$project$Resources$View$books) : (A2($elm$core$String$contains, 'games', urlString) ? $author$project$Resources$View$viewResources($author$project$Resources$View$games) : (A2($elm$core$String$contains, 'podcasts', urlString) ? $author$project$Resources$View$viewResources($author$project$Resources$View$podcasts) : (A2($elm$core$String$contains, 'prayer', urlString) ? $author$project$Resources$Prayer$Main$view : (A2($elm$core$String$contains, 'subscriptions', urlString) ? $author$project$Resources$View$viewResources($author$project$Resources$View$subscriptions) : (A2($elm$core$String$contains, 'videos', urlString) ? $author$project$Resources$View$viewResources($author$project$Resources$View$videos) : A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'height', '100vh'),
		...
		_List_fromArray(
			[
				A2($author$project$Header$viewSubpageHeader, 'Resources', $author$project$Helpers$headerMargin),
				$author$project$Resources$View$viewBody,
				$author$project$Footer$viewFooter
			])))))));
};
var $author$project$Saints$SaintHelpers$SaintRoute = function (a) {
	return {$: 'SaintRoute', a: a};
};
var $author$project$Saints$SaintHelpers$urlSaintParser = A2(
	$elm$url$Url$Parser$questionMark,
	$elm$url$Url$Parser$s('saints'),
	$elm$url$Url$Parser$Query$string('s'));
var $author$project$Saints$SaintHelpers$route = A2($elm$url$Url$Parser$map, $author$project$Saints$SaintHelpers$SaintRoute, $author$project$Saints$SaintHelpers$urlSaintParser);
var $author$project$Saints$SaintHelpers$parseRoute = $elm$url$Url$Parser$parse($author$project$Saints$SaintHelpers$route);
var $elm$core$Tuple$second = function (_v0) {
	var y = _v0.b;
	return y;
};
var $author$project$Saints$Main$viewBackButton = A2(
	$elm$html$Html$a,
	_List_fromArray(
		[
...
var $author$project$Saints$Main$viewFeastDay = function (saint) {
...
var $author$project$Saints$Main$ChangePatronageView = function (a) {
	return {$: 'ChangePatronageView', a: a};
};
var $author$project$Saints$Main$Full = {$: 'Full'};
var $elm$core$Char$toUpper = _Char_toUpper;
var $author$project$Saints$Main$viewPatronage = F2(
	function (model, saint) {
		...
		var displayToggle = (_Utils_eq(model.patronageView, $author$project$Saints$Main$Partial) && isShowingEverything) ? ' hidden' : '';
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick(
							$author$project$Saints$Main$ChangePatronageView(
								_Utils_eq(model.patronageView, $author$project$Saints$Main$Full) ? $author$project$Saints$Main$Partial : $author$project$Saints$Main$Full))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							_Utils_eq(model.patronageView, $author$project$Saints$Main$Full) ? 'View Less' : 'View More')
						]))
				]));
	});
var $author$project$Saints$Main$viewSaintPage = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($elm$html$Html$map, $author$project$Saints$Main$SignupMsg, $author$project$Signup$view4)
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[$author$project$Saints$Main$viewBackButton])),
							A2(
							$elm$html$Html$h1,
							_List_fromArray(
								[
							...
							if (maybeSaint.$ === 'Nothing') {
								...
								var activities = A2(
									...
									$author$project$Saints$SaintHelpers$activitiesFromSaint(saint));
								return A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											$author$project$Saints$Main$viewFeastDay(saint),
											A2($author$project$Saints$Main$viewPatronage, model, saint),
											A2($author$project$FeastDayActivities$FeastDayHelpers$viewAllActivities, model.saintList.isLoading, activities)
										]));
							}
						}()
...
var $author$project$Saints$Main$SetQuery = function (a) {
	return {$: 'SetQuery', a: a};
};
var $elm$regex$Regex$contains = _Regex_contains;
var $author$project$Saints$SaintHelpers$monthList = _List_fromArray(
	['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']);
var $author$project$Saints$SaintHelpers$removeLeadingZero = function (input) {
	return (A2($elm$core$String$left, 1, input) === '0') ? A2($elm$core$String$dropLeft, 1, input) : input;
};
var $elm$core$String$trim = _String_trim;
var $author$project$Saints$SaintHelpers$convertDate = function (input) {
	var monthPattern = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		...
		$elm$core$List$head(
			function (monthQuery) {
				return A2(
					...
					$author$project$Saints$SaintHelpers$monthList);
			}(
				$elm$core$String$toLower(
					A2(
						$elm$core$Maybe$withDefault,
	...
	var date = $author$project$Saints$SaintHelpers$removeLeadingZero(
		A2(
			$elm$core$Maybe$withDefault,
			'',
			A2(
...
var $author$project$Saints$Main$saintSort = F3(
	function (model, a, b) {
...
var $author$project$Saints$Main$dropBefore = F2(
...
var $author$project$Saints$Main$takeUntil = F2(
	function (delimiter, string) {
		var _v0 = A2($elm$core$String$split, delimiter, string);
		if (_v0.b) {
			var before = _v0.a;
...
var $author$project$Saints$Main$highlightString = F3(
		...
		if ((substring === '') || ($elm$core$List$length(parts) === 1)) {
			...
			if (parts.b) {
				...
				var highlightedText = A3(
					...
					string);
				var beforeText = A2(
					$author$project$Saints$Main$dropBefore,
					';',
					function (s) {
				...
				var afterText = A2(
					$author$project$Saints$Main$takeUntil,
					';',
					function (s) {
...
var $author$project$Saints$Main$viewSaint = F2(
	function (model, saint) {
		var patronage = A3(
			$elm$core$String$slice,
			1,
			-1,
			A3($elm$core$String$replace, '\';\'', ', ', saint.patronOf));
		var nameHighlight = A3($author$project$Saints$Main$highlightString, false, model.query, saint.name);
		var altNames = A3(
			$elm$core$String$slice,
			1,
			-1,
		...
		var extra = (model.query === '') ? A2($elm$html$Html$span, _List_Nil, _List_Nil) : (A2(
			...
			_List_fromArray(
				[
					...
					A3($author$project$Saints$Main$highlightString, true, model.query, altNames)
				])) : (A2(
			$elm$core$String$contains,
			$elm$core$String$toLower(
				$author$project$Saints$SaintHelpers$convertDate(model.query)),
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Feast Day: '),
					A3(
					$author$project$Saints$Main$highlightString,
					true,
					$author$project$Saints$SaintHelpers$convertDate(model.query),
					saint.feastDay)
				])) : (A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Patronage: '),
					A3($author$project$Saints$Main$highlightString, true, model.query, patronage)
...
var $author$project$Saints$Main$viewSaints = function (model) {
	...
	var filteredSaints = $elm$core$String$isEmpty(query) ? model.saintList.saints : A2(
		...
		$author$project$Saints$Main$saintSort(model),
		A2(
			$elm$core$List$filter,
			function (s) {
				return A2(
					...
					A2(
						...
						$elm$regex$Regex$fromString(
							'^' + $elm$core$String$toLower(
								$author$project$Saints$SaintHelpers$convertDate(query)))),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Saints$Main$SetQuery),
								A2($elm$html$Html$Attributes$style, 'box-shadow', '#777 1px 1px 5px'),
								$elm$html$Html$Attributes$class('rounded p-4 mb-4 text-lg w-full text-xl')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
						...
						A2(
							$elm$core$List$map,
							$author$project$Saints$Main$viewSaint(model),
							filteredSaints))
					]))
			]));
};
var $author$project$Saints$Main$viewBody = F2(
	function (model, saintName) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							if (saintName.$ === 'Just') {
								var s = saintName.a;
								return A2($author$project$Saints$Main$viewSaintPage, model, s);
							} else {
								return $author$project$Saints$Main$viewSaints(model);
							}
						}()
						]))
				]));
	});
var $author$project$Saints$Main$view = function (model) {
	var currentRoute = $author$project$Saints$SaintHelpers$parseRoute(model.url);
	return {
		body: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2($author$project$Header$viewSubpageHeader, 'Saints', $author$project$Helpers$headerMargin),
						function () {
						if (currentRoute.$ === 'Just') {
							var s = currentRoute.a.a;
							return A2($author$project$Saints$Main$viewBody, model, s);
						} else {
							return A2($author$project$Saints$Main$viewBody, model, $elm$core$Maybe$Nothing);
						}
					}(),
						$author$project$Footer$viewFooter
					]))
...
var $author$project$Shop$View$viewAboutShopItems = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Shop$View$viewEtsyLink = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Shop$View$viewPrintfulLink = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('flex flex-col gap-4 items-center md:items-start')
...
var $author$project$Shop$View$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('max-w-3xl'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$author$project$Shop$View$viewAboutShopItems])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[$author$project$Shop$View$viewEtsyLink, $author$project$Shop$View$viewPrintfulLink]))
		]));
var $author$project$Shop$View$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'height', '100vh'),
	...
	_List_fromArray(
		[
			A2($author$project$Header$viewSubpageHeader, 'Shop', $author$project$Helpers$headerMargin),
			$author$project$Shop$View$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Newsroom$View$viewSignUpButton = A2(
	$elm$html$Html$a,
	_List_fromArray(
		[
...
var $author$project$Newsroom$View$viewSignUp = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			$author$project$Newsroom$View$viewSignUpButton
		]));
var $author$project$Team$View$viewAbout = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$author$project$Newsroom$View$viewSignUp])),
			A2(
			$elm$html$Html$h2,
			_List_fromArray(
				[
...
var $author$project$Team$View$cfnLive = {image: '/assets/images/ProfilePictures/CFN.png', link: 'https://vimeo.com/963295296/89fc748d09?share=copy', name: 'CFN Live'};
var $author$project$Team$View$christianChannel = {image: '/assets/images/ProfilePictures/ChristianChannel.png', link: 'https://youtu.be/p4yi5EFbPAI?si=L0jtHxwFyyS4jMjC', name: 'Christian Channel'};
var $author$project$Team$View$inHisImage = {image: '/assets/images/ProfilePictures/InHisDesign.png', link: 'https://youtu.be/eqOmqdlNIDw?si=E9xTDcqQV_nFFQs-', name: 'In His Image Podcast'};
var $author$project$Team$View$makeJoyNormal = {image: '/assets/images/ProfilePictures/MakeJoyNormal.png', link: 'https://podcasts.apple.com/ca/podcast/catholic-stories-for-children-an-interview-with/id1512837291?i=1000631285156', name: 'Make Joy Normal Podcast'};
var $author$project$Team$View$ocCatholic = {image: '/assets/images/ProfilePictures/OCCatholic.png', link: 'https://www.occatholic.com/catholic-stories-for-children-helping-the-next-generation-understand-the-faith/', name: 'Orange County Catholic'};
var $author$project$Team$View$spiritFilledMedia = {image: '/assets/images/ProfilePictures/SpiritFilledMedia.png', link: 'https://www.buzzsprout.com/1467955/10425762-finding-your-way-catholic-stories-for-children-guest-trevor-rothaus ', name: 'Spirit Filled Media Podcast'};
var $author$project$Team$View$viewInTheMedia = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			A2(
				...
				$author$project$Resources$Helpers$viewResource,
				_List_fromArray(
					[$author$project$Team$View$spiritFilledMedia, $author$project$Team$View$makeJoyNormal, $author$project$Team$View$christianChannel, $author$project$Team$View$ocCatholic, $author$project$Team$View$inHisImage, $author$project$Team$View$cfnLive])))
		]));
...
var $author$project$Team$Team$boardOfAdvisors = _List_fromArray(
	[$author$project$Team$Team$fredrick, $author$project$Team$Team$aaron, $author$project$Team$Team$chris]);
var $author$project$Team$Team$danaMiller = {description: '', image: $author$project$Team$Team$imagePath + 'DanaMiller.jpeg', initials: 'DM', name: 'Dana Miller', position: 'Voice Actor', socials: _List_Nil};
var $author$project$Team$Team$dominicGrodi = {description: '', image: '', initials: 'DG', name: 'Dominic Grodi', position: 'Singer and Voice Actor', socials: _List_Nil};
...
var $author$project$Team$Team$ekaterina = {
...
var $author$project$Team$Team$emmaGreene = {
...
var $author$project$Team$Team$ethanNagy = {description: '', image: '', initials: 'EN', name: 'Ethan Nagy', position: 'Singer and Voice Actor', socials: _List_Nil};
var $author$project$Helpers$IMDB = {$: 'IMDB'};
var $author$project$Helpers$LinkedIn = {$: 'LinkedIn'};
var $author$project$Team$Team$fernandoAlanis = {
...
var $author$project$Team$Team$francescoSchito = {
...
var $author$project$Team$Team$italiaRose = {description: '', image: '', initials: 'IR', name: 'Italia Rose', position: 'Singer and Voice Actor', socials: _List_Nil};
var $author$project$Team$Team$jadenLuo = {description: '', image: $author$project$Team$Team$imagePath + 'JadenLuo.jpeg', initials: 'JL', name: 'Jaden Luo', position: 'Voice Actor', socials: _List_Nil};
...
var $author$project$Team$Team$makoAnimation = {
...
var $author$project$Team$Team$nickAndAlina = {
...
var $author$project$Team$Team$rachaelWorkmanMcLaughlin = {
...
var $author$project$Team$Team$seanBeeson = {
...
var $author$project$Team$Team$willMaciejewski = {
...
var $author$project$Team$Team$contractors = _List_fromArray(
	[$author$project$Team$Team$kelly, $author$project$Team$Team$nickAndAlina, $author$project$Team$Team$seanBeeson, $author$project$Team$Team$makoAnimation, $author$project$Team$Team$ekaterina, $author$project$Team$Team$rachaelWorkmanMcLaughlin, $author$project$Team$Team$francescoSchito, $author$project$Team$Team$willMaciejewski, $author$project$Team$Team$emmaGreene, $author$project$Team$Team$ethanNagy, $author$project$Team$Team$italiaRose, $author$project$Team$Team$dominicGrodi, $author$project$Team$Team$fernandoAlanis, $author$project$Team$Team$danaMiller, $author$project$Team$Team$jadenLuo]);
var $author$project$Team$Team$carlos = {description: '', image: $author$project$Team$Team$imagePath + 'CarlosG.jpg', initials: '', name: 'Carlos Gutierrez', position: 'Business Consultant', socials: _List_Nil};
var $author$project$Team$Team$lindsey = {description: 'Lindsey is a Jill-of-all-trades with a background in entertainment production (theater, theme-park, opera, film), events, music, and education. A Catholic convert from an evangelical background, she is passionate about passing along the riches of the faith - especially to those who may not recognize the treasure trove of the Church! Having worked for Disney in the parks and at Imagineering for over a decade, Lindsey has developed a taste for artistic excellence and hopes to bring a high level of quality to the Catholic creative sphere. Like Tolkien, she is a big believer in the power of myth and fairy tales for developing minds, she aims to tell stories that prepare children for a life of adventure, meaning, virtue, and purpose.', image: $author$project$Team$Team$imagePath + 'LindseyBruno.jpg', initials: '', name: 'Lindsey Bruno', position: 'Creative Director', socials: _List_Nil};
var $author$project$Team$Team$staff = _List_fromArray(
	[$author$project$Team$Team$trevor, $author$project$Team$Team$carlos, $author$project$Team$Team$lindsey]);
...
var $author$project$Team$Team$viewPeople = F3(
				...
				A2(
					...
					function (person) {
						return A2(
							...
							_List_fromArray(
								[
									$author$project$Team$Team$viewPerson(person)
								]));
					},
					people)));
	});
var $author$project$Team$View$viewTeam = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A3($author$project$Team$Team$viewPeople, 'Staff', '', $author$project$Team$Team$staff)
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A3($author$project$Team$Team$viewPeople, 'Board of Advisors', '', $author$project$Team$Team$boardOfAdvisors)
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A3($author$project$Team$Team$viewPeople, 'Talent', 'A number of talented artists, contractors, teams and people help bring these animations to life.', $author$project$Team$Team$contractors)
				]))
		]));
var $author$project$Team$View$viewBody = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('hcenter'),
	...
	_List_fromArray(
		[
			...
			$author$project$Team$View$viewAbout,
			$author$project$Team$View$viewInTheMedia,
			$author$project$Team$View$viewTeam
		]));
var $author$project$Team$View$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'height', '100vh'),
	...
	_List_fromArray(
		[
			...
			$author$project$Team$View$viewBody,
			$author$project$Footer$viewFooter
		]));
var $author$project$Home$Sections$viewLaritasStudios = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('flex flex-col items-center justify-center text-center space-y-2 py-20 logo-section-bg'),
			A2($elm$html$Html$Attributes$style, 'font-family', 'Cinzel'),
			A2($elm$html$Html$Attributes$style, 'color', '#ffbf00'),
			A2($elm$html$Html$Attributes$style, 'text-shadow', '   0 0 5px #FFD700, 0 0 10px #FFD700, 0 0 15px #FFD700, 0 0 20px #FFAA00;')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src('/assets/images/home/ClaritasStudios.png'),
					$elm$html$Html$Attributes$alt('Claritas Studios Logo'),
					$elm$html$Html$Attributes$class('mb-2'),
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('uppercase tracking-wide text-base md:text-lg font-semibold drop-shadow-md')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Illuminating the journey to sainthood')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('through the art of animation.')
				]))
		]));
var $author$project$Home$Sections$viewMission = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('relative flex items-center mission-background')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('text-white w-full px-20 sm:px-6 lg:px-8 py-20')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-4xl md:text-5xl font-bold mb-2 tracking-tight text-left'),
							A2($elm$html$Html$Attributes$style, 'font-family', 'Lora')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Let’s Become Saints Together')
						])),
					A2(
					$elm$html$Html$h2,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-xl md:text-2xl font-light uppercase tracking-widest mb-4 text-left border-b border-white inline-block pb-1')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('max-w-2xl text-lg md:text-xl leading-relaxed text-left mt-4')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('We are a Catholic non-profit animation studio with the mission of inspiring people of all ages to become the saints they were destined to be.')
						]))
				]))
		]));
var $author$project$Home$Sections$viewSanctifyScreenTime = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('relative flex items-center sanctify-screen-time-background')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Sanctify Your Screen Time')
						])),
					A2(
					$elm$html$Html$h2,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('OUR ANIMATED SHOWS')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Because of your generous support we offer a number of shows and shorts on our website or on YouTube. Sing along with the saints and angels, learn about the Church, and pray with your Catholic heroes.')
						]))
				]))
		]));
...
var $author$project$Main$viewSlideshow = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('logo-section-bg')
			]),
		_List_fromArray(
			[
				A2(
				...
				A3($author$project$Animations$Helpers$Carousel$viewSlides, model.animationsPageModel.slideshow, $author$project$Animations$View$NextSlide, $author$project$Animations$View$PrevSlide))
			]));
};
var $author$project$Home$Sections$viewSupportMission = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('relative flex items-center support-mission-background')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('How to Support our Mission')
						])),
					A2(
					$elm$html$Html$h2,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('CONNECT & CONTRIBUTE')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Animation takes a lot of time and resources. By supporting our non-profit, we can connect millions of future saints all over the world and bring the light of faith.')
						]))
				]))
		]));
var $author$project$Home$Sections$viewTechnologyArtCollide = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('relative flex items-center technology-art-collide-background')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('When Technology and Art Collide')
						])),
					A2(
					$elm$html$Html$h2,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('MEET OUR TEAM')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Claritas Studios (formerly Catholic Stories for Children) was started when a software engineer noticed his Catechism students didn’t know much about their faith and were always on their phones. Hear the whole story.')
						]))
				]))
		]));
var $author$project$Home$Sections$viewWhatPeopleSaying = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('relative flex items-center what-people-saying-background')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('What People are Saying')
						])),
					A2(
					$elm$html$Html$h2,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('PRESS & TESTIMONIALS')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('These animated stories have already impacted the lives of thousands of Catholic families. See what God is doing through media.')
						]))
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Home$Sections$viewLaritasStudios,
				$author$project$Home$Sections$viewMission,
				$author$project$Home$Sections$viewSanctifyScreenTime,
				$author$project$Home$Sections$viewTechnologyArtCollide,
				$author$project$Home$Sections$viewWhatPeopleSaying,
				$author$project$Home$Sections$viewSupportMission
			]));
};
	...
	var _v0 = function () {
		...
		switch (_v1.$) {
			...
			case 'Navigation':
				return {
					body: _List_fromArray(
						[$author$project$Navigation$View$view]),
					title: 'Navigation'
				};
			case 'Give':
				return {
					body: _List_fromArray(
						[$author$project$Give$View$view]),
					title: 'Donate'
				};
			case 'Contact':
				return {
					body: _List_fromArray(
						[$author$project$Contact$View$view]),
					title: 'Contact Us'
				};
			case 'AboutUs':
				return {
					body: _List_fromArray(
						[$author$project$Team$View$view]),
					title: 'About Us'
				};
			case 'Shop':
				return {
					body: _List_fromArray(
						[$author$project$Shop$View$view]),
					title: 'Shop'
				};
			case 'Resources':
				return {
					body: _List_fromArray(
						[
							$author$project$Resources$View$view(model.url)
						]),
					title: 'Resources'
				};
			case 'Prayers':
				return {
					body: _List_fromArray(
						[$author$project$Prayers$View$view]),
					title: 'Prayers'
				};
			case 'Angelus':
				return {
					body: _List_fromArray(
						[$author$project$Prayer$Angelus$View$view]),
					title: 'Angelus'
				};
			case 'Saints':
				var saintPageModel = model.saintsPageModel;
				var document = $author$project$Saints$Main$view(
					_Utils_update(
						saintPageModel,
						{url: model.url}));
				return {
			...
			case 'Feasts':
				var document = $author$project$FeastDayActivities$Main$view(model.feastsPageModel);
				return {
					body: A2(
						$elm$core$List$map,
			...
			case 'Productions':
				var document = A2($author$project$Animations$View$view, model.url, model.animationsPageModel);
				return {
					body: A2(
						$elm$core$List$map,
			...
			default:
				var document = $author$project$NotFound$Main$view;
				return {
					body: _List_fromArray(
						[
							A2(
